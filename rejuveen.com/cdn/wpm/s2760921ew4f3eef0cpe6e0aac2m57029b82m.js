(() => {
  ...
  (r.amdO = {}),
    ...
    (() => {
      ...
      const h = "production",
        m = "2760921ew4f3eef0cpe6e0aac2m57029b82",
        v = "s2760921ew4f3eef0cpe6e0aac2m57029b82m.js";
      ...
      class g extends Error {
        constructor(e, t = {}) {
          ...
          super(e),
            ...
            (this.groupingHash =
              null !== (r = t.groupingHash) && void 0 !== r
                ? r
                : "Error" === this.name
                ? void 0
                : this.name);
      ...
      const R = (e, t) => {
        ...
        j = (e, { context: t }) => {
          const r = "v1/" + (t ? `${t}/` : "");
          return null == e || A.includes(typeof e) || Array.isArray(e)
            ? `${r}UnknownError`
            : "string" == typeof e
            ? `${r}${e}`
        ...
        T = {
          ...
          notify: (e, t) => {
            try {
              ...
              if (
                r.browserTarget === x.NotAvailable ||
                r.browserTarget === x.Unknown ||
                r.surface === y.NotAvailable ||
                r.surface === y.Unknown ||
                !N(r.shopUrl)
              )
      ...
      function L(e, { cache: t, cacheKey: r } = {}) {
        function n(...t) {
          const o = n.cache,
            i = (r ?? M).apply(this, t);
      ...
      function z(e) {
        (function ({ webPixelApi: e, cookie: t, cookieRestrictedDomains: r }) {
          ...
          (function ({ origin: e }) {
            _(window, "origin", { get: () => e, configurable: !1 });
          })(e),
          (function ({ referrer: e }) {
            _(document, "referrer", { get: () => e, configurable: !1 });
          })(e),
      ...
      function V(e) {
        const t = new URL(e);
        if ("https:" !== t.protocol)
          throw new $(`URL must be secure (HTTPS): ${t.href}`);
        if (/^\/api\/.+\/graphql\.json$/.test(t.pathname)) return t;
        const r = W.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
        if (new RegExp(`^${W.protocol}//(.*@)?${r}`, "i").test(t.href))
          throw new q(`Requests are not allowed to the same origin: ${t.href}`);
        return t;
      }
      ...
      const ie = async (e) => {
        ...
        (oe = !0), a(o);
        try {
          te && (o.browser.sendBeacon = P),
            te || (z(e), (self.document.title = t));
        } catch (s) {
          throw (
            (T.notify(s, {
              pixelId: r.id,
        ...
        return (
          await ne?.call(o, o),
          { status: "success", hashVersion: m, sandboxUrl: W.href || "unknown" }
        );
      };
      (() => {
        try {
          (function (
            ...
            { callable: [] }
          ).expose({ initialize: ie });
        } catch (e) {
          T.notify(e, { context: `createSandbox/${re}` });
        }
        !(function (e, t = self) {
          const r = {
            ...(e ? Z : J),
          ...
          e ||
            ...
            _(self, "String", { writable: !1, configurable: !1 }),
            _(self, "Request", { writable: !1, configurable: !1 }),
            _(self, "URL", { writable: !1, configurable: !1 }),
            _(self, "RegExp", { writable: !1, configurable: !1 });
        })(te);
      })();
    })();
})();
