        ...
        return (
          E &&
            h(N).then(function () {
              ...
              for (var _ = 0, U = E.length; _ < U; _++)
                w.hasAttribute(E[_]) &&
                  b({ target: w, attributeName: E[_], oldValue: null });
            }),
          w
        );
      };
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var n = !0,
      ...
      u = function (c) {
        var p =
          ...
          N = function U(mt, vt, tt, x, $, q) {
            ...
            try {
              for (it.s(); !(Pt = it.n()).done; ) {
                ...
                (q || o in Q) &&
                  ($
                    ? tt.has(Q) || (tt.add(Q), x.delete(Q), c(Q, $))
                    : x.has(Q) || (x.add(Q), tt.delete(Q), c(Q, $)),
                  q || U(Q[o](vt), vt, tt, x, $, n));
              }
            } catch (Ce) {
              it.e(Ce);
            } finally {
          ...
          _ = E.observe;
        return (
          (E.observe = function (U) {
            return _.call(E, U, { subtree: n, childList: n });
          })(p),
          E
        );
      },
      ...
      M = function (h) {
        var c = new I(),
          ...
          b = function () {
            for (var x = mt.takeRecords(), $ = 0, q = x.length; $ < q; $++)
              E(z.call(x[$].removedNodes, k), !1),
                E(z.call(x[$].addedNodes, k), !0);
          },
          w = function (x) {
          ...
          N = function (x, $) {
            var q;
            if ($)
              for (var it, Pt = w(x), Q = 0, Ce = _.length; Q < Ce; Q++)
                Pt.call(x, (it = _[Q])) &&
                  (c.has(x) || c.set(x, new C()),
                  (q = c.get(x)),
                  q.has(it) || (q.add(it), h.handle(x, $, it)));
            else
              c.has(x) &&
                ((q = c.get(x)),
                c.delete(x),
                q.forEach(function (Di) {
                  h.handle(x, $, Di);
                }));
          },
          E = function (x) {
        ...
        return (
          ...
          _.length && E(U[d](_)),
          { drop: p, flush: b, observer: mt, parse: E }
        );
      },
      P = self,
      F = P.document,
      ...
      G = function (c) {
        for (
          var p = A(c), b = [], w = new Y(), N = p.length, E = 0;
          E < N;
          E++
        ) {
          b[E] = c[p[E]];
    ...
    if (R) {
      ...
      (self.customElements = {
        ...
        m((B.prototype = et.prototype), "constructor", { value: B }),
        (self.HTMLElement = B),
    ...
    } else if (((R = !self.customElements.get("extends-br")), R))
      try {
        var or = function h() {
        ...
        var sr = "extends-br";
        self.customElements.define("extends-br", or, { extends: "br" }),
          (R = F.createElement("br", { is: sr }).outerHTML.indexOf(sr) < 0);
    ...
    if (R) {
      var lr = function (c) {
        ...
        Ii = M({ query: ie, handle: Ai }),
        hr = Ii.parse,
        _i = M({
          query: fr,
          handle: function (c, p) {
            De.has(c) &&
              (p ? Pe.add(c) : Pe.delete(c), ie.length && lr.call(ie, c));
          },
        }),
        Ni = _i.parse,
        pr = L.prototype.attachShadow;
      pr &&
        (L.prototype.attachShadow = function (h) {
      ...
      T(self)
        ...
        .forEach(function (h) {
          ...
          m((p.prototype = c.prototype), "constructor", { value: p }),
            m(self, h, { value: p });
        }),
        (F.createElement = function (h, c) {
          var p = c && c.is;
        ...
        (at.define = function (h, c, p) {
          ...
          var b,
            w = p && p.extends;
          te.set(c, w ? { is: h, tag: w } : { is: "", tag: h }),
            w
              ? ((b = "".concat(w, '[is="').concat(h, '"]')),
                ur.set(b, c.prototype),
                re.set(h, c),
                ie.push(b))
              : (Ei.apply(at, arguments), fr.push((b = h))),
            Fe(h).then(function () {
              w
                ? (hr(F.querySelectorAll(b)), Pe.forEach(lr, [b]))
                : Ni(F.querySelectorAll(b));
            }),
            ee.get(h)._(c);
        });
    }
...
function $i() {
  ...
  if (
    (r > -1 && (oe = parseInt(navigator.userAgent.substring(r + 7))),
    t && oe && oe < 110)
  )
    return;
  let i = "instantMousedownShortcut" in document.body.dataset;
  (vr = "instantAllowQueryString" in document.body.dataset),
    (gr = "instantAllowExternalLinks" in document.body.dataset),
    (yr = "instantWhitelist" in document.body.dataset);
  ...
  if (
    (o || document.addEventListener("touchstart", Wi, n),
    s
      ? i || document.addEventListener("mousedown", Bi, n)
      : document.addEventListener("mouseover", Vi, n),
    i && document.addEventListener("mousedown", Ki, n),
    u)
  ) {
...
function Vi(e) {
  ...
  let t = e.target.closest("a");
  se(t) &&
    (t.addEventListener("mouseout", Hi, { passive: !0 }),
    (Rt = setTimeout(() => {
...
function se(e) {
  if (
    !(!e || !e.href) &&
    !(yr && !("instant" in e.dataset)) &&
    !(
      e.origin != location.origin &&
      (!(gr || "instant" in e.dataset) || !oe)
    ) &&
    ["http:", "https:"].includes(e.protocol) &&
    !(e.protocol == "http:" && location.protocol == "https:") &&
    !(!vr && e.search && !("instant" in e.dataset)) &&
...
var xr = [
  ...
  ce =
    !Sr && Element.prototype.getRootNode
      ? function (e) {
          var t;
  ...
  gt = function (t) {
    ...
    return t.tabIndex < 0 &&
      (/^(AUDIO|VIDEO|DETAILS)$/.test(t.tagName) || Ui(t)) &&
      !Ar(t)
      ? 0
      : t.tabIndex;
  },
      ...
      for (var r = t.parentElement; r; ) {
        if (r.tagName === "FIELDSET" && r.disabled) {
          for (var i = 0; i < r.children.length; i++) {
            ...
            if (n.tagName === "LEGEND")
              return Ot.call(r, "fieldset[disabled] *") ? !0 : !n.contains(t);
          }
          return !0;
        }
        r = r.parentElement;
  ...
  _r = function (t, r) {
    ...
    return (
      r.getShadowRoot
        ? (i = Tr([t], r.includeContainer, {
            filter: ke.bind(null, r),
            flatten: !1,
            getShadowRoot: r.getShadowRoot,
            shadowRootFilter: on,
          }))
        : (i = Or(t, r.includeContainer, ke.bind(null, r))),
      sn(i)
    );
  },
  Nr = function (t, r) {
    ...
    return (
      r.getShadowRoot
        ...
        : (i = Or(t, r.includeContainer, fe.bind(null, r))),
      i
    );
  },
  Tt = function (t, r) {
    ...
    var i = r?.document || document,
      ...
      y = function (a) {
        ...
        if (typeof l == "function") {
          for (
            var m = arguments.length, A = new Array(m > 1 ? m - 1 : 0), T = 1;
            T < m;
            T++
          )
            A[T - 1] = arguments[T];
        ...
        var D = l;
        if (typeof l == "string" && ((D = i.querySelector(l)), !D))
          throw new Error(
          ...
          ((o.containerGroups = o.containers.map(function (a) {
            ...
            return {
              ...
              nextTabbableNode: function (st) {
                ...
                return rt < 0
                  ? ct
                    ? m.slice(m.indexOf(st) + 1).find(function (ht) {
                        return Tt(ht);
                      })
                    : m
                        .slice(0, m.indexOf(st))
                        .reverse()
                        .find(function (ht) {
                          return Tt(ht);
                        })
        ...
        if (o.tabbableGroups.length > 0) {
          ...
          if (R < 0)
            ...
            if (
              (B < 0 &&
                (G.container === l ||
                  (de(l, s.tabbableOptions) &&
                    !Tt(l, s.tabbableOptions) &&
                    !G.nextTabbableNode(l, !1))) &&
                (B = R),
              B >= 0)
            ) {
      ...
      M = function (a) {
        ...
        if (!(f(l, a) >= 0)) {
          if (Mt(s.clickOutsideDeactivates, a)) {
            u.deactivate({ returnFocus: s.returnFocusOnDeactivate });
            return;
          }
      ...
      W = function (a) {
        dn(a) &&
          Mt(s.escapeDeactivates, a) !== !1 &&
          (a.preventDefault(), u.deactivate());
      },
      H = function (a) {
        var l = he(a);
        f(l, a) >= 0 ||
          Mt(s.clickOutsideDeactivates, a) ||
          Mt(s.allowOutsideClick, a) ||
      ...
      K = function () {
        if (o.active)
          return (
            ...
            i.removeEventListener("keydown", W),
            u
          );
      },
      L = function (a) {
    ...
    return (
      (u = {
        ...
        deactivate: function (a) {
          ...
          return D && T
            ? (T(k(o.nodeFocusedBeforeActivation)).then(R, R), this)
            : (R(), this);
        },
        pause: function (a) {
...
function bn(e, t, r, i, n) {
  let s,
    o,
    u = 0;
  do (o = t + (r - t) / 2), (s = zr(o, i, n) - e), s > 0 ? (r = o) : (t = o);
  while (Math.abs(s) > gn && ++u < yn);
  return o;
}
function _t(e, t, r, i) {
  if (e === t && r === i) return X;
    ...
    (this.tick = (v) => {
      ...
      t(j),
        ...
        (this.playState === "finished" || I >= this.totalDuration + o)
          ? ((this.playState = "finished"),
            (C = this.resolve) === null || C === void 0 || C.call(this, j))
          : this.playState !== "idle" &&
...
function pe(e) {
  return (
    Ve.has(e) || Ve.set(e, { transforms: [], values: new Map() }), Ve.get(e)
  );
}
function jr(e, t) {
...
var Be = (e, t) => document.createElement("div").animate(e, t),
  Hr = {
    ...
    finished: () => !!Be({ opacity: [0, 1] }, { duration: 0.001 }).finished,
    linearEasing: () => {
      try {
...
function we(e, t, r, i = {}, n) {
  ...
  let W = qt(t),
    ...
    Y = wt.get(W);
  return (
    be(H.animation, !(yt(v) && H.generator) && i.record !== !1),
    () => {
      let K = () => {
          var O, S;
          return (S =
            (O = Gt.get(e, W)) !== null && O !== void 0
              ? O
      ...
      if (
        (Ut(W) && (Et.cssRegisterProperty() ? Br(W) : (j = !1)),
        F && !Et.linearEasing() && (Z(v) || (lt(v) && v.some(Z))) && (j = !1),
        j)
      ) {
        Y && (L = L.map((a) => (J(a) ? Y.toDefaultUnit(a) : a))),
          L.length === 1 && (!Et.partialKeyframes() || o) && L.unshift(K());
        let O = {
          delay: bt.ms(f),
          duration: bt.ms(d),
          endDelay: bt.ms(y),
        ...
        u.finished
          ...
          .catch($t),
          z || (u.playbackRate = 1.000001);
      } else if (n && F)
        (L = L.map((O) => (typeof O == "string" ? parseFloat(O) : O))),
          L.length === 1 && L.unshift(parseFloat(K())),
          (u = new n(
            (O) => {
              Gt.set(e, W, et ? et(O) : O);
            },
            L,
            Object.assign(Object.assign({}, i), { duration: d, easing: v })
          ));
      else {
        let O = L[L.length - 1];
      ...
      return (
        o &&
          s(
            ...
            t,
            L,
            { duration: d, delay: f, easing: v, repeat: g, offset: k },
            "motion-one"
          ),
        H.setAnimation(u),
        u && !M && u.pause(),
    ...
    get: (e, t) => {
      ...
      switch (t) {
        ...
        case "finished":
          return (
            e.finished ||
              (e.finished = Promise.all(e.animations.map(Mn)).catch($t)),
            e.finished
          );
        case "stop":
          return () => {
...
function Zr(e, t, r, i, n, s) {
  ...
  for (let o = 0; o < t.length; o++)
    e.push({ value: t[o], at: At(n, s, i[o]), easing: jt(r, o) });
}
function Xr(e, t) {
    ...
    s.forEach((g, v) => {
      for (let C in g) {
        ...
        for (let P = 0; P < I.length; P++) {
          let { at: F, value: j, easing: W } = I[P];
          k.push(j), z.push(ot(0, y, F)), M.push(W || V.easing);
        }
        z[0] !== 0 && (z.unshift(0), k.unshift(k[0]), M.unshift("linear")),
          z[z.length - 1] !== 1 && (z.push(1), k.push(null)),
          n.push([
            v,
            C,
            k,
...
var Ie = { start: 0, center: 0.5, end: 1 };
function Ge(e, t, r = 0) {
  let i = 0;
...
function ai(e, t, r, i) {
  ...
  return (
    J(e)
      ...
      : ut(e) &&
        ((e = e.trim()),
        e.includes(" ") ? (n = e.split(" ")) : (n = [e, Ie[e] ? e : "0"])),
    (s = Ge(n[0], r, i)),
    (o = Ge(n[1], t)),
    s - o
  );
...
function li(e, t, r) {
  ...
  y &&
    ((t[s].interpolate = Wt(It(g), t[s].offset)),
...
var nt = { IDLE: "idle", LOADING: "loading", LOADED: "loaded", ERROR: "error" };
function so(e) {
  return (
...
var Ye = class {
  ...
  tr = class {
    ...
    load(t, r) {
      ...
      (this.element && !r) ||
        this.instance.dispatch("contentLoad", { content: this, isLazy: t })
          .defaultPrevented ||
        (this.isImageContent()
          ? ((this.element = Yt("pswp__img", "img")),
            this.displayedImageWidth && this.loadImage(t))
          : ((this.element = Yt("pswp__content", "div")),
    ...
    onLoaded() {
      (this.state = nt.LOADED),
        this.slide &&
          ...
          (this.state === nt.LOADED || this.state === nt.ERROR) &&
    ...
    setDisplayedSize(t, r) {
      if (
        ...
        !this.instance.dispatch("contentResize", {
          ...
          (Xe(this.element, t, r), this.isImageContent() && !this.isError()))
      ) {
    ...
    isZoomable() {
      return this.instance.applyFilters(
        "isContentZoomable",
        this.isImageContent() && this.state !== nt.ERROR,
        this
      );
    }
    updateSrcsetSizes() {
...
var rr = class extends Qe {
    ...
    _getGalleryDOMElements(t) {
      ...
      return ((r = this.options) !== null && r !== void 0 && r.children) ||
        ...
        ? Qt(this.options.children, this.options.childSelector, t) || []
        : [t];
    }
