  ...
  CountrySelector = class extends HTMLElement {
    ...
    connectedCallback() {
      (this.countryElement = this.querySelector('[name="address[country]"]')),
        ...
        this.hasAttribute("country") && this.getAttribute("country") !== ""
...
function deepQuerySelector(root, selector) {
  ...
  for (const template2 of root.querySelectorAll("template"))
    if (((element = deepQuerySelector(template2.content, selector)), element))
      return element;
  return null;
}
    ...
    connectedCallback() {
      (this._abortController = new AbortController()),
        this.addEventListener(
          ...
          () =>
            (this.controlledElement ?? this).dispatchEvent(
              new CustomEvent("control:prev", { bubbles: !0, cancelable: !0 })
            ),
          { signal: this._abortController.signal }
        ),
        this.controlledElement &&
          ...
          this.controlledElement.addEventListener(
            ...
            (event) =>
              (this.disabled =
                event.detail.position === "start" ? !1 : this.disabled),
            { signal: this._abortController.signal }
          ));
    }
    disconnectedCallback() {
    ...
    connectedCallback() {
      (this._abortController = new AbortController()),
        this.addEventListener(
          ...
          () =>
            (this.controlledElement ?? this).dispatchEvent(
              new CustomEvent("control:next", { bubbles: !0, cancelable: !0 })
            ),
          { signal: this._abortController.signal }
        ),
        this.controlledElement &&
          ...
          this.controlledElement.addEventListener(
            ...
            (event) =>
              (this.disabled =
                event.detail.position === "end" ? !1 : this.disabled),
            { signal: this._abortController.signal }
          ));
    }
    disconnectedCallback() {
...
var ShareButton = class extends HTMLButtonElement {
  constructor() {
    super(),
      navigator.share && this.addEventListener("click", this._showSystemShare);
  }
  _showSystemShare() {
    navigator.share({
...
function getHeadingKeyframe(element, options = {}) {
  ...
  switch (
    ...
    case "split_fade":
      return [
        splitLines,
        { transform: ["translateY(0.5em)", "translateY(0)"], opacity: [0, 1] },
    ...
    constructor() {
      super(),
        ...
        window.matchMedia("(prefers-reduced-motion: no-preference)").matches &&
          window.themeVariables.settings.staggerProductsApparition &&
          inView(
            this,
            __privateMethod(this, _RevealItems_instances, reveal_fn).bind(this),
    ...
    connectedCallback() {
      __privateSet(this, _abortController, new AbortController()),
        this.parentElement.addEventListener(
          "pointermove",
          __privateMethod(this, _CustomCursor_instances, onPointerMove_fn).bind(
            this
          ),
          { passive: !0, signal: __privateGet(this, _abortController).signal }
        ),
        this.parentElement.addEventListener(
          "pointerleave",
          __privateMethod(
    ...
    constructor() {
      super(),
        ...
        new MutationObserver(
          __privateMethod(this, _SplitLines_instances, split_fn).bind(this, !0)
        ).observe(this, {
          characterData: !0,
          attributes: !1,
          childList: !1,
...
(_requireSplit = new WeakMap()),
  ...
  (onWindowResized_fn = function () {
    __privateGet(this, _lastScreenWidth) !== window.innerWidth &&
      (__privateMethod(this, _SplitLines_instances, split_fn).call(this, !0),
...
var BaseCarousel = class extends HTMLElement {
    connectedCallback() {
      (this._abortController = new AbortController()),
        ...
        this.selectedIndex === 0
          ...
          : this.select(this.selectedIndex, { animate: !1, force: !0 });
    }
    disconnectedCallback() {
      this._abortController.abort();
    }
  ...
  EffectCarousel = class extends BaseCarousel {
    ...
    async select(index, { direction, animate: animate19 = !0 } = {}) {
    ...
    _transitionTo(
      fromSlide,
      toSlide,
      { direction = "next", animate: animate19 = !0 } = {}
    ) {
      return (
...
var ScrollCarousel = class extends BaseCarousel {
  ...
  select(index, { animate: animate19 = !0, force = !1 } = {}) {
    const indexBeforeChange = this.selectedIndex;
  ...
  _transitionTo(fromSlide, toSlide, { animate: animate19 = !0 } = {}) {
    fromSlide.classList.remove("is-selected"),
      toSlide.classList.add("is-selected");
  ...
  _adjustHeight() {
    (this.style.maxHeight = null),
      this._scrollArea?.scrollDirection !== "none" && super._adjustHeight();
  }
...
var DialogElement = class _DialogElement extends HTMLElement {
    ...
    hide() {
      if (this.open)
        return (
          this.removeAttribute("open"), waitForEvent(this, "dialog:after-hide")
        );
    }
    get delegate() {
        ...
        case "open":
          if (
            ...
            showTransitionPromise.then(() => {
              this.dispatchEvent(
                new CustomEvent("dialog:after-show", { bubbles: !0 })
              );
            }),
            ...
            hideTransitionPromise.then(() => {
              this.parentElement === document.body &&
                ...
                (this._originalParentBeforeAppend = null)),
                this.dispatchEvent(
                  new CustomEvent("dialog:after-hide", { bubbles: !0 })
                );
            }),
...
var reduceDrawerAnimation =
    ...
    window.themeVariables.settings.reduceDrawerAnimation,
  ...
  LineItem = class extends HTMLElement {
    ...
    async _onChanged(event) {
      if (
        ...
        event.detail.cart.item_count === 0 || event.detail.quantity !== 0)
      )
        return;
...
var FreeShippingBar = class extends HTMLElement {
  ...
  _updateMessage() {
    ...
    if (this.totalPrice >= this.threshold)
      ...
      const replacement = `<span class="bold text-accent">${this._currencyFormatter
        .format((this.threshold - this.totalPrice) / 100)
        .replace(/\$/g, "$$$$")}</span>`;
...
var FacetForm = class extends HTMLFormElement {
  ...
  connectedCallback() {
    Array.from(this.querySelectorAll("details, facet-dialog")).forEach(
      (disclosureElement) => {
        disclosureElement.open && openElements.add(disclosureElement.id),
...
var QuantitySelector = class extends HTMLElement {
    ...
    stepDown() {
      this.inputElement.stepDown(),
        this.inputElement.dispatchEvent(new Event("change", { bubbles: !0 }));
    }
    stepUp() {
  ...
  QuantityInput = class extends HTMLInputElement {
    ...
    set quantity(quantity) {
      const isNumeric =
        ...
        !isNaN(quantity);
      quantity !== "" &&
        ((!isNumeric || quantity < 0) && (quantity = parseInt(quantity) || 1),
        (this.value = Math.max(
          this.min || 1,
          Math.min(quantity, this.max || Number.MAX_VALUE)
        ).toString()),
        this.checkValidity() || this.stepDown());
    }
    _onValueInput() {
      (this.quantity = this.value),
        this.style.setProperty(
          "--quantity-input-characters-count",
          `${this.value.toString().length}ch`
        );
    }
    _onValueChanged() {
      this.value === "" && (this.quantity = this.min || 1),
        this.checkValidity() || this.stepDown(),
        this.style.setProperty(
          "--quantity-input-characters-count",
          `${this.value.toString().length}ch`
...
var ProductCard = class extends HTMLElement {
  ...
  connectedCallback() {
    this._delegate.on(
      "change",
      '.product-card__swatch-list [type="radio"], .product-card__variant-list [type="radio"]',
    ...
    if (
      (target.hasAttribute("data-variant-id") &&
        this.querySelectorAll(
          `a[href^="${Shopify.routes.root}products/${this.getAttribute(
            "handle"
          )}"`
        ).forEach((link) => {
...
var ProductGallery = class extends HTMLElement {
    connectedCallback() {
      ...
      form?.addEventListener(
        "product:rerender",
        this._onSectionRerender.bind(this),
        { signal: this._abortController.signal }
      ),
        form?.addEventListener(
          "variant:change",
            ...
            onInit: (el, pswp) => {
              (el.querySelector(".pagination__page-count").innerText =
                ...
                el
                  ...
                  ?.addEventListener("click", () => pswp.prev()),
                el
                  .querySelector('[rel="next"]')
                  ?.addEventListener("click", () => pswp.next()),
                pswp.on("change", () => {
    ...
    _onVariantChanged(event) {
      ...
      (event.detail.previousVariant === null ||
        ...
        newMediaPosition !== void 0 &&
          this._carousels.forEach((carousel) =>
            carousel.select(newMediaPosition, { animate: !1 })
          );
    }
    ...
    _onButtonClicked() {
      ...
      if (media)
        ...
        openIndex = carousel.visibleItems
          .filter((item) => item.getAttribute("data-media-type") === "image")
  ...
  async _doPredictiveSearch() {
    ...
    return (
      this.querySelector('[slot="results"]').replaceWith(
        document.importNode(nodeElement.querySelector('[slot="results"]'), !0)
      ),
  ...
  SectionHeader = class extends HTMLElement {
    ...
    connectedCallback() {
      window.matchMedia("(prefers-reduced-motion: no-preference)").matches &&
        inView5(
          this,
          __privateMethod(this, _SectionHeader_instances, reveal_fn2).bind(
            this
          ),
...
var SplitCursor = class extends HTMLElement {
  ...
  _onPointerDown(event) {
    (event.target === this || this.contains(event.target)) &&
      ((this._initialX = event.clientX - this._offsetX), (this._dragging = !0));
  }
  ...
  DropdownDisclosure = class _DropdownDisclosure extends AnimatedDetails {
    ...
    _transitionIn(hasOpenSiblings = !1) {
      ...
      return (
        ...
        timeline9(timelineSequence, { delay: hasOpenSiblings > 0 ? 0.1 : 0 })
          .finished
      );
    }
    _transitionOut() {
            ...
            .forEach((promo) => {
              timelineSequence.push(
                [
                  promo,
                  { opacity: [0, 1] },
                  { duration: 0.25, delay: contentDelay, at: "mega-menu" },
                ],
                "mega-menu-promo"
              );
            }),
          this.contentElement
            ...
            .forEach((column) => {
              timelineSequence.push([
                ...
                {
                  easing: "ease",
                  delay: stagger5(0.025, { start: contentDelay }),
                  at: "mega-menu",
                  duration: 0.2,
                },
              ]);
          ...
          [
            this,
            {
              width: [
                ...
                (this.offsetWidth -
                  parseInt(
                    window.getComputedStyle(this).getPropertyValue("padding")
                  )) *
                  2 +
                  "px",
              ],
      ...
      return (
        ...
        [
          ...
          },
          {
            ...
            duration: 0.2,
            at: "-0.15",
            delay: stagger5(0.025, { start: 0.1 }),
          },
        ]
      );
    }
  ...
  connectedCallback() {
    if (
      ...
      scroll(
        ({ y }) => {
          y.current >=
            y.targetOffset + this.featureProductRow.clientHeight / 2 &&
          y.progress < 0.85
...
var ImagesWithTextScrolling = class extends HTMLElement {
  ...
  _onScroll() {
    ...
    for (const [index, contentItem] of this._contentItems.entries()) {
      ...
      if (
        contentItemRect.top < imageBottom - imageRect.height * 0.1 &&
...
var ImpactText = class extends HTMLElement {
  connectedCallback() {
    window.matchMedia("(prefers-reduced-motion: no-preference)").matches &&
      inView9(this, ({ target }) => this._onBecameVisible(target), {
        margin: "-100px",
      });
  }
  async _onBecameVisible(target) {
    if (
      (animate14(
        target,
        { opacity: 1, transform: ["translateY(10px)", "translateY(0)"] },
        { duration: 0.3 }
      ),
      this.hasAttribute("count-up"))
    ) {
      const itemToSearch =
          this.childElementCount === 0 ? this : this.firstElementChild,
      ...
      await animate14(
        (progress) => {
          ...
          charactersMatches.forEach((character) => {
            formattedString.length >= matches[0].length - character.index &&
              (formattedString =
...
var MultipleImagesWithText = class extends HTMLElement {
            ...
            event.target.hasAttribute("image-id") &&
              this._imageCarousel.select(
                this._imageCarousel.items.findIndex(
                  (item) => item.id === event.target.getAttribute("image-id")
                )
              );
          });
    }
        ...
        this.getAttribute("layout") === "stacked"
          ...
          ? timeline14([
              [
                ...
                { duration: 0.3, delay: stagger6(0.1) },
              ],
            ])
          : timeline14([
              [
      ...
      if (direction === "next") {
        ...
        return timeline14(
          [
            [
              fromSlide,
              { opacity: 0, transform: "rotate(5deg) translate(40px, 10px)" },
              { duration: transitionSpeed },
            ],
            [
              toSlide,
              { zIndex: 1 },
              { duration: transitionSpeed, zIndex: { easing: "step-start" } },
            ],
            [
              fromSlide,
              { opacity: 1, transform: fromSlideTransform, zIndex: -1 },
              {
                duration: transitionSpeed,
                at: "<",
        ...
        return timeline14(
          [
            ...
            this.items.length >= 3 && [
              fromSlide.previousElementSibling || this.lastElementChild,
              { zIndex: -1 },
              { easing: "step-start" },
            ],
            [
  ...
  MultipleImagesWithTextContentList = class extends EffectCarousel {
    ...
    _reveal() {
      animate16(
        ...getHeadingKeyframe(this.querySelector('[reveal-on-scroll="true"]'))
      );
    }
    _transitionTo(
      fromSlide,
    ...
    async _transitionTo(fromSlide, toSlide, options = {}) {
      await timeline15([
        ...
        [
          ...
          {
            opacity: [null, 0],
            ...(reduceMotion2 && { transform: [null, "translateY(-10px)"] }),
          },
          { duration: 0.2, at: "<" },
        ],
      ]).finished,
  ...
  connectedCallback() {
    if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches)
      if (window.ScrollTimeline) {
        const timeline18 = new ViewTimeline({ subject: this, axis: "block" });
        this.animate(
          {
            transform: [
...
var Slideshow = class extends HTMLElement {
    ...
    async _onSlideSelected(event) {
      ...
      if (
        (this.style.setProperty(
          ...
          slideStyles.getPropertyValue("--slideshow-slide-controls-background")
        ),
        this.style.setProperty(
  ...
  SlideshowCarousel = class extends EffectCarousel {
      ...
      super.connectedCallback(),
        this._player &&
          ...
          (this._player.addEventListener("player:start", (event) => {
            ...
            Array.from(this.querySelectorAll(".numbered-dots__item")).forEach(
              (item) => {
        ...
        !window.matchMedia("(prefers-reduced-motion: reduce)").matches &&
          (this._reloaded ||
            timeline17([
              ...
              [
                ...getHeadingKeyframe(
                  selectedSlide.querySelector('[data-sequence="heading"]'),
                  { duration: 0.3, at: "content" }
                ),
              ],
              [
    ...
    _fade(fromSlide, toSlide) {
      return timeline17([
        [
          fromSlide,
          { opacity: [1, 0], visibility: ["visible", "hidden"], zIndex: 0 },
          { duration: 0.3, easing: "ease-in", zIndex: { easing: "step-end" } },
        ],
        [
          toSlide,
          { opacity: [0, 1], visibility: ["hidden", "visible"], zIndex: 1 },
    ...
    async _onSlideSelected(event) {
      if (
        (Array.from(this.querySelectorAll("video-media")).forEach((video) =>
          video.pause()
        ),
...
document.addEventListener(
  "click",
  function (event) {
    if (event.target.matches(".add-subscription")) {
      event.preventDefault();
      var link = event.target,
        variantId = link.getAttribute("data-variant-id"),
        sellingPlanId = link.getAttribute("data-selling-plan-id"),
        lineKey = link.getAttribute("data-line-key"),
        quantity = link.getAttribute("data-quantity");
      updateLineItemToSubscription(lineKey, variantId, sellingPlanId, quantity);
    }
    if (event.target.matches(".quantity-decrement")) {
      var input = event.target
          .closest("line-item-quantity")
    ...
    if (event.target.matches(".quantity-increment")) {
      var input = event.target
        .closest("line-item-quantity")
        .querySelector(".quantity-input");
      input.stepUp(), input.dispatchEvent(new Event("change", { bubbles: !0 }));
    }
  },
  !1
);
function updateLineItemToSubscription(
  lineKey,
  variantId,
  sellingPlanId,
  quantity
  ...
  var lineItemElement =
    document.querySelector('line-item [data-line-key="' + lineKey + '"]') ||
    document.querySelector("line-item");
  if (lineItemElement) {
    var willChangeEvent = new CustomEvent("line-item:will-change", {
      bubbles: !0,
    });
    lineItemElement.dispatchEvent(willChangeEvent);
  }
  getLineItemIndex(lineKey)
    .then(function (lineIndex) {
    ...
    .then(function (updatedCart) {
      if (lineItemElement) {
        var changeEvent = new CustomEvent("line-item:change", {
          bubbles: !0,
          detail: { cart: updatedCart, quantity: parseInt(quantity, 10) },
        });
        lineItemElement.dispatchEvent(changeEvent);
      }
...
async function getLineItemIndex(lineKey) {
  try {
    var cartResponse = await fetch("/cart.js");
    if (!cartResponse.ok) throw new Error("Cart data could not be fetched.");
    var cart = await cartResponse.json(),
      lineIndex = cart.items.findIndex(function (item) {
        return item.key === lineKey;
      });
    if (lineIndex === -1) throw new Error("Line item not found in cart.");
    return lineIndex + 1;
  } catch (error) {
    throw error;
  }
}
async function handleChangeVariantClick(event) {
  event.preventDefault();
  var button = event.currentTarget,
    direction = button.getAttribute("data-direction"),
    parent = button.closest(".variant-selector"),
    productHandle = parent.getAttribute("data-product-handle"),
    currentVariantId = parent.getAttribute("data-current-variant-id"),
    lineKey = parent.getAttribute("data-line-key"),
    quantity = parseInt(parent.getAttribute("data-line-quantity"), 10);
  try {
    ...
    var product = await productResponse.json(),
      ...
      currentIndex = variants.findIndex(function (variant) {
        return variant.id == currentVariantId;
      });
    if (currentIndex === -1)
      throw new Error("Current variant not found in product variants.");
    var newIndex;
    if (direction === "next") newIndex = (currentIndex + 1) % variants.length;
    else if (direction === "prev")
      newIndex = (currentIndex - 1 + variants.length) % variants.length;
    else return;
    var newVariant = variants[newIndex];
    if (!newVariant.available) {
      alert("The selected variant is not available.");
      return;
    }
    var lineItemIndex = await getLineItemIndex(lineKey);
    if (lineItemIndex === -1) throw new Error("Line item not found in cart.");
    ...
    if (!changeResponse.ok) throw new Error("Cart could not be updated.");
    var cartData = await changeResponse.json();
    document.dispatchEvent(new Event("cart:refresh"));
  } catch (error) {
    alert(error.message);
  }
...
function initializeVariantChangeButtons() {
  var buttons = document.querySelectorAll(".change-variant");
  buttons.forEach(function (button) {
    button.addEventListener("click", handleChangeVariantClick);
  });
}
document.addEventListener("DOMContentLoaded", function () {
  initializeVariantChangeButtons();
});
//# sourceMappingURL=/cdn/shop/t/3/assets/theme.js.map?v=100581619955198391821738738302
