!(function (e) {
  ...
  const t = {
    ...
    a = { PREFERENCES: "p", ANALYTICS: "a", MARKETING: "m", SALE_OF_DATA: "t" },
    s = { MARKETING: "m", ANALYTICS: "a", PREFERENCES: "p", SALE_OF_DATA: "s" },
    u = {
      MARKETING: "marketing",
      ANALYTICS: "analytics",
    ...
    if ("object" == typeof e) {
      ...
      for (const n in e)
        e.hasOwnProperty(n) &&
          void 0 !== e[n] &&
          "" !== e[n] &&
          t.push("".concat(n, ":").concat(S(e[n], !0)));
      const o = t.join(",");
      return n ? "{".concat(o, "}") : o;
    }
      ...
      (function () {
        try {
          ...
          const [n] =
            ...
            t = null == n ? void 0 : n.serverTiming.find((e) => e.name === I);
  ...
  class W {
    ...
    produce(e, n) {
      if (this.instrumentationEnabled() && x())
        try {
          const t = {
    ...
    void 0 !== e.granular_consent &&
      (function (e) {
        const n = e[a.MARKETING],
          ...
          i = e[a.PREFERENCES];
        !0 === n
          ? X(t.MARKETING_ACCEPTED)
          : !1 === n && X(t.MARKETING_DECLINED);
        !0 === o
          ? X(t.SALE_OF_DATA_ACCEPTED)
          : !1 === o && X(t.SALE_OF_DATA_DECLINED);
        !0 === r
          ? X(t.ANALYTICS_ACCEPTED)
          : !1 === r && X(t.ANALYTICS_DECLINED);
        !0 === i
          ? X(t.PREFERENCES_ACCEPTED)
          : !1 === i && X(t.PREFERENCES_DECLINED);
        const c = (function (e) {
          const n = {
  ...
  function X(e, n) {
    try {
      ...
      console.error(
        '[Shopify Customer Privacy] Error in event listener for "'.concat(
          e,
          '":'
        ),
        n
  ...
  function z(e, n, t) {
    try {
      ...
      !(function (e) {
        const n = new XMLHttpRequest();
        n.open("POST", "https://error-analytics-production.shopifysvc.com", !0),
          n.setRequestHeader("Content-Type", "application/json"),
          n.setRequestHeader("Bugsnag-Api-Key", Z),
      ...
      "object" == typeof e && e.headlessStorefront && !e.storefrontAccessToken
        ...
        : (function (e, t) {
                ...
                if ("boolean" != typeof e && "object" != typeof e)
                  throw new n(
                    'setTrackingConsent received an invalid argument of type "'.concat(
                      ...
                      "See ".concat(he, " for documentation.")
                  );
                if ("object" == typeof e) {
                  ...
                  if (0 === t.length)
                    throw new n(
                      "The submitted consent object is empty. " +
                        "Expected at least one consent key: ".concat(ge, ". ") +
            ...
            if (!0 === e || !1 === e) {
              ...
              o = { analytics: e, preferences: e, marketing: e };
            } else o = e;
            const r = (function (e) {
                if (!e) return null;
            ...
            return pe(
              h(
                h({ granular_consent: o }, null !== r && { referrer: r }),
  ...
  const ie = (e) => {
    let { useBugsnagReporting: n, useInstrumentation: t } = e;
    ...
    for (const e in o)
      o.hasOwnProperty(e) && (o[e] = r.includes(e) ? o[e] : Q(o[e]));
    return o;
  };
  function ce() {
    return ie(
  ...
  function ae(e) {
    ...
    const t = J(),
      o = (function () {
        ...
        return "" === n && "" === t && "" === o
          ? null
          : "a".concat(n, "m").concat(t, "p").concat(o);
      })();
    for (const r of Array.from(n)) {
      ...
      if (
        (t && i.searchParams.set("consent_id", t),
      ...
      t = S(
        h(
          h(
            ...
            n.email && { visitorEmail: n.email }
          ),
          {},
          { origReferrer: e.referrer, landingPage: e.landing_page }
        )
      );
    return {
  ...
  function pe(e, n) {
    const t = e.granular_consent,
      ...
      i = t.isExtensionToken
        ? "Shopify-Storefront-Extension-Token"
        : "x-shopify-storefront-access-token",
      c = {
        headers: h({ "content-type": "application/json", [i]: o }, !1),
        body: JSON.stringify(Ee(e)),
        method: "POST",
      };
    return fetch("https://".concat(r, "/api/unstable/graphql.json"), c)
      .then((e) => {
      ...
      .then((o) => {
        ...
        const c = 31536e6,
          ...
          p =
            null !==
              (r =
                null === (i = o.data.consentManagement) || void 0 === i
                  ? void 0
                  : i.customerAccountUrl) && void 0 !== r
              ? r
              : "";
        return (
          d &&
          ...
          t.headlessStorefront &&
            (D(P, u, c, d),
            f && E && (D(de, u, a, f), D(fe, u, a, E)),
            l !== u &&
              (D(P, l, c, d), f && E && (D(de, l, a, f), D(fe, l, a, E)))),
          $(e),
          ae(p),
          void 0 !== n && n(null, o),
          o
  ...
  function me(e, n) {
    ...
    return pe({ granular_consent: { sale_of_data: e } }, n);
  }
  function ye() {
    if ((new W().produce("getTrackingConsent"), M())) return i.NO_VALUE;
    const e = k();
    return e[s.MARKETING] === c.ACCEPTED && e[s.ANALYTICS] === c.ACCEPTED
      ? i.ACCEPTED
      : e[s.MARKETING] === c.DECLINED || e[s.ANALYTICS] === c.DECLINED
      ? i.DECLINED
      : i.NO_INTERACTION;
  }
  function we() {
    new W().produce("getRegulation"),
      _.warn("getRegulation is deprecated and will be removed.");
    const e = K();
    return "" === e
      ? ""
      : [
  ...
  function _e() {
    return (
      new W().produce("getShopPrefs"),
      _.warn("getShopPrefs is deprecated and will be removed."),
      { limit: [] }
    );
  }
  function Te() {
  ...
  function Ne() {
    return (
      ...
      _.warn("isRegulationEnforced is deprecated and will be removed."),
      !0
    );
  }
  function ve() {
  ...
  function Re() {
    return !1 === De()
      ? i.DECLINED
      : ((e = b()),
        M() ? i.NO_VALUE : e === c.NO_VALUE ? i.NO_INTERACTION : F(e));
    var e;
  }
  function Le() {
    return (
      new W().produce("shouldShowCCPABanner"),
      _.warn("shouldShowCCPABanner is deprecated and will be removed."),
      H() && Re() === i.NO_INTERACTION
    );
  }
  function Oe() {
    return !0;
  ...
  function Me() {
    var e, n, o, r;
    const i = ce({ useBugsnagReporting: !0, useInstrumentation: !0 });
    if (
      (null === (e = window.Shopify.trackingConsent) || void 0 === e
        ? void 0
        : e.__metadata__) ||
      (null === (n = window.Shopify.customerPrivacy) || void 0 === n
        ? void 0
        : n.__metadata__)
    ) {
      const e =
          null === (o = window.Shopify.customerPrivacy.__metadata__) ||
          void 0 === o
            ? void 0
            : o.version,
    ...
    (window.Shopify.customerPrivacy = window.Shopify.trackingConsent = c),
      X(t.CONSENT_TRACKING_API_LOADED);
  }
  (window.Shopify = window.Shopify ? window.Shopify : {}),
    Me(),
    (e.default = ce),
    (e.setGlobalObject = Me),
