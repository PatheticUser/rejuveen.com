import { i as e } from "./chunk.modal_Coo4kjcu.esm.js";
...
function f(e) {
  try {
    return JSON.parse(p(`${h}:${e}`, { session: !0 }));
  } catch (e) {
    return null;
  }
}
function m(e) {
  return Object.assign(Object.assign({}, e), { id: s() });
}
function g(e, t) {
  let n = t;
  t && (n = m(t)), u(`${h}:${e}`, JSON.stringify(n), { session: !0 });
}
function v(e) {
  var t, n, o;
  null ===
    (o =
      null ===
        (n =
          null === (t = null == c ? void 0 : c.Shopify) || void 0 === t
            ? void 0
            : t.SignInWithShop) || void 0 === n
        ? void 0
        : n.renderToast) ||
    void 0 === o ||
    o.call(n, m(e));
...
function F(e, t, n) {
  ...
  if (
    (arguments.length > 2 &&
      (a.children = arguments.length > 3 ? x.call(arguments, 2) : n),
...
function q(e) {
  ((!e.__d && (e.__d = !0) && S.push(e) && !K.__r++) ||
    P != k.debounceRendering) &&
    ((P = k.debounceRendering) || M)(K);
}
function K() {
  for (var e, t, n, o, r, i, a, s = 1; S.length; )
    S.length > s && S.sort(C),
      (e = S.shift()),
      (s = S.length),
      e.__d &&
...
function X(e, t, n, o, r, i, a, s, l, c, d) {
  ...
  for (
          ...
          ? ((l = i + p),
            ((a = e.__k[i] =
              ...
              a.constructor == String
                ...
                : D(a)
                ? $(B, { children: a }, null, null, null)
                : void 0 === a.constructor && a.__b > 0
                ? $(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v)
                : a).__ = e),
            (a.__b = e.__b + 1),
            (s = null),
            -1 != (c = a.__i = J(a, n, l, u)) &&
    ...
    null != (h = n.__k[u]) &&
      ((p = -1 == h.__i ? A : v[h.__i] || A),
      (h.__i = u),
      (g = te(e, h, p, r, i, a, s, l, c, d)),
      (f = h.__e),
      h.ref &&
        p.ref != h.ref &&
        (p.ref && ie(p.ref, null, h), d.push(h.ref, h.__c || f, h)),
      null == m && null != f && (m = f),
      4 & h.__u || p.__k === h.__k
        ? (l = Y(h, l, e))
...
function Z(e, t, n) {
  "-" == t[0]
    ...
    : (e[t] =
        null == n ? "" : "number" != typeof n || R.test(t) ? n : n + "px");
}
  ...
  e: if ("style" == t)
    ...
    (i = t != (t = t.replace(O, "$1"))),
      ...
      n
        ? o
          ? (n.u = o.u)
          : ((n.u = T), e.addEventListener(t, i ? I : j, i))
        : e.removeEventListener(t, i ? I : j, i);
  else {
...
function te(e, t, n, o, r, i, a, s, l, c) {
  ...
  e: if ("function" == typeof C)
    try {
      if (
        ((v = t.props),
        (_ = "prototype" in C && C.prototype.render),
        (y = (d = C.contextType) && o[d.__c]),
        ...
        _ &&
          ...
          (u.__s == u.state && (u.__s = z({}, u.__s)),
          z(u.__s, C.getDerivedStateFromProps(v, u.__s))),
        (h = u.props),
        (f = u.state),
        (u.__v = t),
        p)
        ...
        if (
          ...
          (!u.__e &&
            ...
            !1 === u.shouldComponentUpdate(v, u.__s, b)) ||
            t.__v == n.__v)
        ) {
          for (
        ...
        null != u.componentWillUpdate && u.componentWillUpdate(v, u.__s, b),
          _ &&
      ...
      (u.state = u.__s),
        null != u.getChildContext && (o = z(z({}, o), u.getChildContext())),
        _ &&
          !p &&
        ...
        null != d &&
          d.type === B &&
          null == d.key &&
          (P = oe(d.props.children)),
        (s = X(e, D(P) ? P : [P], t, n, o, r, i, a, s, l, c)),
        (u.base = t.__e),
        (t.__u &= -161),
    ...
    null == i && t.__v == n.__v
      ...
      : (s = t.__e = re(n.__e, t, n, o, r, i, a, l, c));
...
function re(e, t, n, o, r, i, a, s, l) {
  ...
  if (null == e) {
    ...
    (e = document.createElementNS(r, _, v.is && v)),
    ...
    for (c in v)
      (h = v[c]),
        "children" == c
          ...
          : "checked" == c
          ? (m = h)
          : (s && "function" != typeof h) || g[c] === h || Q(e, c, h, g[c], r);
    if (d)
      s ||
...
function le(e, t, n) {
  ...
  t == document && (t = document.documentElement),
    k.__ && k.__(e, t),
    (r = (o = "function" == typeof n) ? null : t.__k),
    (i = []),
    (a = []),
    te(
      t,
      (e = ((!o && n) || t).__k = F(B, null, [e])),
      r || A,
      A,
      t.namespaceURI,
      !o && n ? [n] : r ? null : t.firstChild ? x.call(t.childNodes) : null,
      i,
...
function ce(e, t, n) {
  ...
  for (i in (e.type && e.type.defaultProps && (a = e.type.defaultProps), t))
    "key" == i
      ...
      : "ref" == i
      ? (r = t[i])
      : (s[i] = void 0 === t[i] && null != a ? a[i] : t[i]);
  return (
    arguments.length > 2 &&
      (s.children = arguments.length > 3 ? x.call(arguments, 2) : n),
    $(e.type, s, o || e.key, r || e.ref, null)
  );
}
function de(e) {
  function t(e) {
...
(x = L.slice),
  ...
  (H.prototype.setState = function (e, t) {
    ...
    (n =
      ...
      "function" == typeof e && (e = e(z({}, n), this.props)),
      e && z(n, e),
      null != e && this.__v && (t && this._sb.push(t), q(this));
  }),
  (H.prototype.forceUpdate = function (e) {
    this.__v && ((this.__e = !0), e && this.__h.push(e), q(this));
  }),
  (H.prototype.render = B),
  (S = []),
  (M =
...
(ye.__b = function (e) {
  ...
  (ye.__r = function (e) {
    ...
    t &&
      (me === fe
        ...
        : (t.__h.forEach(Ue), t.__h.forEach(Fe), (t.__h = []), (he = 0))),
      (me = fe);
  }),
  (ye.diffed = function (e) {
    ...
    t &&
      t.__H &&
      (t.__H.__h.length &&
        ((1 !== _e.push(t) && ge === ye.requestAnimationFrame) ||
          ((ge = ye.requestAnimationFrame) || ze)(Re)),
...
((We.prototype = new H()).isPureReactComponent = !0),
  ...
  ((Qe.prototype = new H()).__c = function (e, t) {
    ...
    var s = function () {
      if (!--o.__u) {
        ...
        var t;
        for (o.setState({ __a: (o.__b = null) }); (t = o.o.pop()); )
          t.forceUpdate();
      }
    };
...
function rt(e) {
  ...
  le(F(ot, { context: t.context }, e.__v), t.v);
}
function it(e, t) {
  var n = F(rt, { __v: e, h: t });
...
k.event = function (e) {
  return (
    pt && (e = pt(e)),
    (e.persist = ht),
    (e.isPropagationStopped = ft),
    (e.isDefaultPrevented = mt),
    (e.nativeEvent = e)
  );
};
var gt = {
  ...
  "string" == typeof e.type &&
    (function (e) {
      ...
      "select" == n &&
        ...
        (o.value = G(t.children).forEach(function (e) {
        ...
        t.class && !t.className
          ? ((o.class = t.class), Object.defineProperty(o, "className", gt))
  ...
  (function () {
    if ("undefined" != typeof document && !("adoptedStyleSheets" in document)) {
      ...
      (p.replace = function (e) {
        ...
        r(M, Symbol.hasInstance, { configurable: !0, value: x });
      ...
      if (
        ((N.prototype = {
          ...
          connect: function () {
            var e = j(this);
            v.get(this).observe(e, h),
              g.get(this).length > 0 && I(this),
              T(e, function (e) {
                C(e).connect();
              });
          },
...
function kt({ children: e, instanceId: t, type: n, variant: o }) {
  const r = je(null),
    [i, a] = Me(null),
    { notify: s } = wt();
  return (
    ...
    Te(() => {
      if (i) {
        ...
        e.replace(xt)
          ...
          .catch((e) => {
            s(
              new Error(`Failed to adopt stylesheets for portal provider: ${e}`)
            );
          });
      }
    }, [i, s]),
...
const Et = de({
  ...
  Mt = () => Le(Pt),
  Ct = de({ devMode: !1, element: null, instanceId: "" }),
  Ot = () => Le(Ct),
  Tt = de({
    dispatch: () => {
      throw new Error(
  ...
  It = ({ children: e }) => {
    const { leaveBreadcrumb: t, notify: n } = wt(),
      { trackModalStateChange: o } = St(),
      r = Ae(
        ({ action: e, previousState: r, state: i }) => {
          const a = r.modalVisible !== i.modalVisible,
            s = i.modalVisible ? "shown" : "hidden";
          if (
            ("loaded" === e.type &&
              (o({ currentState: "loaded", reason: "event_loaded" }),
              t("iframe loaded", {}, "state")),
            a)
          )
            switch (e.type) {
              case "loaded":
                o({ currentState: s, reason: "event_loaded_with_auto_open" });
                break;
              case "windoidOpened":
                o({
                  currentState: s,
                ...
                break;
              case "showModal":
                o({ currentState: s, reason: e.reason });
                break;
              case "hideModal":
                o({
                  currentState: s,
                ...
                break;
              case "reset":
                o({ currentState: s, reason: "event_restarted" });
                break;
              default:
                n(
                  new Error(
                    `Could not determine state change reason for action: ${e}`
                  )
                );
            }
        },
        ...
        (e, t) => {
          const n = ((e, t) => {
            switch (t.type) {
              ...
              case "uiRendered":
                return Object.assign(Object.assign({}, e), { uiRendered: !0 });
              case "showModal":
                return e.modalForceHidden && "user_button_clicked" !== t.reason
                  ? e
          ...
          return r({ action: t, previousState: e, state: n }), n;
        },
        [r]
      ),
      [a, s] = Ce(i, {
    ...
    return pe(Tt.Provider, { value: l, children: e });
  };
function Nt(e) {
  return At(e).map((e) =>
    e instanceof Error
...
var Ft = class {
  ...
  constructor(e) {
    (this.apiKey = e.apiKey),
      ...
      this.plugins.forEach((e) => e.load(this)),
      this.leaveBreadcrumb("Bugsnag started", void 0, "state"),
      (e.withSessionTracking ?? 1) &&
        ((this.session = {
  ...
  notify(
    ...
    let l = Nt(e),
      c = { ...this.metadata, ...this.persistedMetadata, ...i },
  ...
  buildBugsnagEvent(
    ...
    return {
      ...
      exceptions: g,
      severity: n,
      severityReason: { type: o },
      unhandled: !r,
      app: { id: d, type: u, version: p, releaseStage: h },
      device: { time: l, locale: f, userAgent: m },
      breadcrumbs: c,
      context: a,
      metaData: i,
      groupingHash: s,
...
function Xt(e) {
  if (Array.isArray(e)) return { arrayValue: { values: e.map((e) => Xt(e)) } };
  switch (typeof e) {
    case "boolean":
...
class en {
  constructor({ exporter: e, attributes: t }) {
    Object.defineProperty(this, Gt, { writable: !0, value: void 0 }),
      ...
      Object.defineProperty(this, Zt, { writable: !0, value: [] }),
      Object.defineProperty(this, Qt, { writable: !0, value: [] }),
      (Vt(this, Gt)[Gt] = e),
      (Vt(this, Jt)[Jt] = null != t ? t : {});
  }
  addAttributes(e) {
    Vt(this, Jt)[Jt] = { ...Vt(this, Jt)[Jt], ...e };
  }
  histogram({
    name: e,
    value: t,
  ...
  counter({ name: e, value: t, unit: n, attributes: o, requiresKeepalive: r }) {
  ...
  gauge({ name: e, value: t, unit: n, attributes: o, requiresKeepalive: r }) {
    const i = 1e6 * Date.now();
    Vt(this, Zt)[Zt].push({
      name: e,
      type: "gauge",
  ...
  log({ body: e, attributes: t, requiresKeepalive: n }) {
  ...
  async exportMetrics() {
    Vt(this, Zt)[Zt].forEach((e) => {
      e.attributes = { ...Vt(this, Jt)[Jt], ...e.attributes };
    });
    const e = Vt(this, Zt)[Zt];
    (Vt(this, Zt)[Zt] = []),
      await this.exportByKeepalive(e, (e, t) =>
        Vt(this, Gt)[Gt].exportMetrics(this.aggregateMetrics(e), t)
      );
  }
  async exportLogs() {
    ...
    (Vt(this, Qt)[Qt] = []),
      await this.exportByKeepalive(e, (e, t) =>
        Vt(this, Gt)[Gt].exportLogs(this.formatLogs(e), t)
      );
  }
  aggregateMetrics(e) {
    const t = {};
        ...
        switch (e.type) {
          case "histogram":
            !(function (e, t) {
              ...
              const {
                ...
                l = null !== (n = t.bounds) && void 0 !== n ? n : Yt,
          ...
          case "exponential_histogram":
            !(function (e, t) {
              ...
              const l = o <= 0 ? 0 : o,
                ...
                f = { offset: o > 0 ? u : 0, bucketCounts: o > 0 ? [1] : [] };
          ...
          case "gauge":
            !(function (e, t) {
              ...
              (e[n] ||= { name: n, unit: r || "1", gauge: { dataPoints: [] } }),
  ...
  async exportByKeepalive(e, t) {
    ...
    const r = [
      n.length > 0 ? t(n, { keepalive: !0 }) : void 0,
      o.length > 0 ? t(o, { keepalive: !1 }) : void 0,
    ].filter((e) => void 0 !== e);
    await Promise.all(r);
  }
  formatLogs(e) {
    return e.map((e) => {
      const t = {
        ...
        attributes:
          ((n = { ...Vt(this, Jt)[Jt], ...e.attributes }),
          Object.entries(n).map(([e, t]) => ({ key: e, value: Xt(t) }))),
      };
      var n;
...
class cn {
  constructor(e, t, n) {
    ...
    Object.defineProperty(this, on, { writable: !0, value: void 0 }),
      ...
      (Vt(this, on)[on] = e.replace(/\/v1\/(logs|metrics|traces)\/?$/, "")),
      (Vt(this, rn)[rn] = t),
      (Vt(this, an)[an] = null == n ? void 0 : n.logger),
      (Vt(this, sn)[sn] = null == n ? void 0 : n.fetchFn),
      (Vt(this, ln)[ln] =
        null !== (o = null == n ? void 0 : n.maxPayloadSizeBytes) &&
        void 0 !== o
          ? o
          : 51200);
  }
  async exportMetrics(e, t) {
    var n;
    const o =
      null === (n = null == t ? void 0 : t.keepalive) || void 0 === n || n;
        ...
        resourceMetrics: [
          {
            resource: {
              attributes: [
                {
                  key: "service.name",
                  value: { stringValue: Vt(this, rn)[rn] },
                },
              ],
            },
            scopeMetrics: [
  ...
  async exportTo(e, t, n) {
    ...
    if (i > Vt(this, ln)[ln])
      throw new un(`Payload size ${i} exceeds ${Vt(this, ln)[ln]} bytes`);
    ...
    if (
      (null === (o = Vt(this, an)[an]) ||
        void 0 === o ||
        o.log({ status: a.status }),
      !a.ok)
    ) {
      if (400 === a.status) {
...
class fn {
  constructor({ exporter: e, getKeepalive: t }) {
    tn.set(this, void 0),
      nn.set(this, void 0),
      w(this, tn, e, "f"),
      w(this, nn, t, "f");
  ...
  exportMetrics(e, t) {
    return y(this, void 0, void 0, function* () {
      var n;
      try {
        yield b(this, tn, "f").exportMetrics(
          e,
        ...
        if (o instanceof dn) {
          const r =
            null === (n = o.metadata) || void 0 === n ? void 0 : n.retryAfter;
          if (r)
            return void (yield new Promise((n) => {
              setTimeout(
                () => this.exportMetrics(e, t).finally(n),
                1e3 * r.seconds
              );
            }));
        }
...
const vn = [
  ...
  wn = (e) => {
    const { errorClass: t, message: n } = e;
    return Boolean(
      "NetworkError" === t ||
        vn.some((e) => (null == n ? void 0 : n.includes(e))) ||
        ((o = n),
        Boolean(
          (null == o
            ? void 0
            : o.includes(
              ...
              )) || (null == o ? void 0 : o.includes("Backpressure applied"))
        ))
    );
    var o;
  },
  xn = ({ event: e, metadata: t, onNetworkError: o }) => {
    var r, i, a, s, l, d, u;
    ...
    if (
      ((e, t) => {
        const { errorClass: n, message: o } = e,
          r =
            "SecurityError" === n &&
            (null == o
              ? void 0
            ...
            (null == o ? void 0 : o.includes("sandboxed")),
          i =
            "SecurityError" === n &&
            (null == o ? void 0 : o.includes("Blocked a frame with origin")) &&
            (null == o
              ? void 0
              : o.includes("from accessing a cross-origin frame")),
          a = "string" == typeof t && yn.has(t),
          s = e.stacktrace.some((e) => e.inProject);
        return Boolean(!s || r || (i && a));
      })(p, "string" == typeof h ? h : void 0)
    )
      return !1;
    ...
    const f =
        null ===
          (a =
            null === (i = c.Shopify) || void 0 === i
              ? void 0
              : i.featureAssets) || void 0 === a
          ? void 0
          : a["shop-js"],
      m = Boolean(f && Object.keys(f).length > 0),
      g = Array.from(n.querySelectorAll('script[src*="/shop-js/"]')).map(
        (e) => e.src
      );
    (e.device = {
      ...
      orientation:
        null ===
          (l =
            null === (s = c.screen) || void 0 === s ? void 0 : s.orientation) ||
        void 0 === l
          ? void 0
          : l.type,
        ...
        Object.assign(Object.assign({}, e.metaData), t),
        {
          custom: Object.assign(
            Object.assign(
              Object.assign(
                {},
                null === (d = e.metaData) || void 0 === d ? void 0 : d.custom
              ),
              t.custom
            ),
            {
              ...
              compactUX: !0,
              domain:
                null === (u = null == c ? void 0 : c.location) || void 0 === u
                  ? void 0
                  : u.hostname,
              shopJsUrls: g,
      ...
      (e.request = { url: c.location.href });
  };
class kn {
  constructor(e) {
    this.opentelClient = new hn({ exporter: gn() });
    const t = (function ({ metadata: e, onNetworkError: t }) {
      return {
        apiKey: Ht,
        appId: "shop-js",
        appVersion: "1.0.34-beta",
        onError: (n) => xn({ event: n, metadata: e, onNetworkError: t }),
  ...
  leaveBreadcrumb(e, t, n) {
    this.client
      ? this.client.leaveBreadcrumb(e, t, n)
  ...
  notify(e, t) {
    return y(this, void 0, void 0, function* () {
      var n;
      this.client
        ? this.client.notify(e, t)
        : null === (n = console.warn) ||
          void 0 === n ||
          n.call(console, "Bugsnag.notify() called before client creation.");
    });
  }
  handleNetworkError(e = "NetworkError") {
    this.opentelClient.counter({
      attributes: { feature: this.feature, error: e },
...
const En = ({ children: e }) => {
  const { featureName: t } = Ot(),
    n = Ne(() => {
      const { client: e, leaveBreadcrumb: n, notify: o } = new kn(t);
      return { client: e, leaveBreadcrumb: n, notify: o };
    }, [t]);
  return pe(bt.Provider, { value: n, children: e });
};
function Sn(e) {
...
function Pn(e) {
  return e
    .replace(/([a-z0-9])([A-Z])/g, (e, t, n) => `${t}-${n.toLowerCase()}`)
    .replace(/[\s_]+/g, "-");
}
...
function Cn({ children: e }) {
  const [t] = (function (e) {
      ...
      return (
        ...
        fe.componentDidCatch ||
          (fe.componentDidCatch = function (e, o) {
            t.__ && t.__(e, o), n[1](e);
          }),
        [
          n[0],
  ...
  return (
    Oe(() => {
      t &&
        n(t instanceof Error ? t : new Mn(t, "UnhandledError"), {
...
function jn(e) {
  return y(
    ...
    arguments,
    void 0,
    function* (e, { maxRetries: t = 3, retryDelay: n = 1e3, signal: o } = {}) {
      const r = (i, a) =>
        y(this, void 0, void 0, function* () {
          var s;
          if (!(null == o ? void 0 : o.aborted))
            try {
              return a ? yield ((s = a), import(s)) : yield e();
            } catch (e) {
              if (!(e instanceof Error) || (null == o ? void 0 : o.aborted))
                return;
              if (i >= t - 1) throw e;
              const a = Tn(e);
              if (a) {
                if (
                  ...
                  null == o ? void 0 : o.aborted)
                )
                  return;
                return r(i + 1, a.href);
              }
              if (
                ((e) => e.message.includes("Importing a module script failed"))(
                  e
                )
              ) {
                if (
...
const In = [
  ...
  Nn = de({ loading: void 0, locale: "en", translations: void 0 });
function An(e) {
...
const Ln = [],
  Rn = [],
  Dn = new Map();
const zn = On(function (e) {
  let t = {};
  const n = Dn.get(e);
  Rn.forEach((e) => {
    t = Object.assign(Object.assign({}, t), e);
  }),
    Dn.set(e, Object.assign(Object.assign({}, n), t)),
    Ln.forEach((e) => e()),
    Ln.splice(0, Ln.length),
    Rn.splice(0, Rn.length);
}, 250);
function Un({ children: e, getFeatureDictionary: t, overrideLocale: o }) {
  const { notify: r } = wt(),
    { recordCounter: i } = Mt(),
    { featureName: a } = Ot(),
    [s, l] = Me(),
    ...
    p = Ae(() => {
      ...
      const t = Object.freeze(
        [
          o,
          n.documentElement.lang,
          null === (e = c.Shopify) || void 0 === e ? void 0 : e.locale,
          ...Bt.languages,
        ].filter((e) => e)
      );
      let r;
      for (const e of t) {
        ...
        try {
          ...
          i("shop_js_unsupported_locale", { attributes: { locale: e } }),
            console.error(`Unsupported locale: "${e}"`);
        } catch (t) {
          i("shop_js_invalid_locale", { attributes: { locale: e } }),
            ...
            try {
              if (!Dn.has(d)) {
                ...
                try {
                  ...
                  r(
                    new Mn(
                      `Failed to load shared translations for "en" locale: ${e}`,
              ...
              if (a && t) {
                ...
                try {
                  ...
                  r(
                    new Mn(
                      `Failed to load ${a} translations for "en" locale: ${e}`,
                      "TranslationFetchError"
                    )
                  );
                }
              ...
              e instanceof Mn &&
                "HandledTranslationFetchError" === e.name &&
                (i("shop_js_handle_silent_error", {
                  attributes: { error: e.name, locale: d },
                }),
                u("en"));
            }
        }),
  ...
  const f = Ne(() => ({ loading: s, locale: d, translations: Dn }), [s, d]);
  return pe(Nn.Provider, { value: f, children: !1 === s && e });
}
  ...
  return (
    ...
    Ae(
      (...e) => {
        var i;
        const a = n && !o.current;
        "number" == typeof o.current && clearTimeout(o.current),
          ...
          a && (null === (i = r.current) || void 0 === i || i.call(r, ...e));
      },
      [t, n]
    )
  );
...
function Zn(e) {
  return e.events.map((e) => {
    ...
    return (
      e &&
        e.options &&
        Object.prototype.hasOwnProperty.call(e.options, "convertEventCase") &&
      ...
      Hn(
        { schema_id: e.schemaId, payload: Gn(e.payload, t) },
        e.metadata && { metadata: Gn(e.metadata, n) }
      )
    );
  });
}
class Qn extends Error {
  constructor(e) {
    super(
      ...
      $n(this, "name", "MonorailUnableToProduceError"),
      (this.response = e),
...
class eo extends Error {
  constructor(e) {
    super(
      `Response not from Monorail Edge. Response received: ${JSON.stringify(e)}`
    ),
      $n(this, "name", "MonorailInterceptedProduceError"),
      (this.response = e),
...
class to extends Error {
  constructor(e) {
    super(
      ...
      $n(this, "name", "MonorailBatchProduceError"),
...
class no extends Error {
  constructor(e, t) {
    super(
      `Error completing request. A network failure may have prevented the request from completing. Error: ${e}. Schemas: ${Array.from(
        new Set(t)
      ).join(", ")}`
    ),
      $n(this, "name", "MonorailRequestError"),
  ...
  constructor(e, t) {
    super(
      `Error reading response from Monorail Edge. Status: ${
        t || "unknown"
      }. Error: ${(null == e ? void 0 : e.message) || "Unknown error"}`
    ),
      $n(this, "name", "MonorailResponseReadError"),
      (this.error = e),
      (this.status = t),
...
class ro {
  ...
  constructor(e = Vn, t = {}) {
    ...
    if (
      ((this.edgeDomain = e),
      (this.optionsOrKeepalive = t),
      "boolean" == typeof t)
    )
      return (
        (this.keepalive = t), void (this.detectInterceptedErrorEnabled = !1)
      );
    (this.keepalive = null !== (n = t.keepalive) && void 0 !== n && n),
      (this.detectInterceptedErrorEnabled =
        null !== (o = t.detectInterceptedErrorEnabled) && void 0 !== o && o);
  }
  async produceBatch(e) {
    const t = { events: Zn(e), metadata: Gn(e.metadata) };
    let n, o;
    try {
    ...
    if (!n.ok) {
      if (
        !Boolean(n.headers.get("x-request-id")) &&
        this.detectInterceptedErrorEnabled
      )
        throw new eo({ status: n.status, message: o });
  ...
  async produce(e) {
    ...
    e &&
      e.options &&
      Object.prototype.hasOwnProperty.call(e.options, "convertEventCase") &&
      (o = Boolean(e.options.convertEventCase));
    try {
      t = await (async function ({ endpoint: e, event: t, keepalive: n }) {
          ...
          ? {
              ...
              eventCreatedAtMs:
                null === (r = t.metadata) || void 0 === r
                  ...
                  : r.eventCreatedAtMs,
              consent:
                null === (i = t.metadata) || void 0 === i ? void 0 : i.consent,
              consent_provider:
        ...
        keepalive: this.keepalive,
        event: Hn(Hn({}, e), {}, { payload: Gn(e.payload, o) }),
      });
    } catch (t) {
      throw new no(t, [e.schemaId]);
    }
    if (!t) throw new Qn({ message: "No response from edge" });
    try {
      n = await t.text();
    } catch (e) {
    ...
    if (!t.ok) {
      if (
        !Boolean(t.headers.get("x-request-id")) &&
        this.detectInterceptedErrorEnabled
      )
        throw new eo({ status: t.status, message: n });
...
function io(e) {
  ...
  return (
    ...
    e &&
      e.deviceInstallId &&
      (t["X-Monorail-Edge-Device-Install-Id"] = e.deviceInstallId),
    e && e.client && (t["X-Monorail-Edge-Client"] = e.client),
    e && e.clientOs && (t["X-Monorail-Edge-Client-OS"] = e.clientOs),
    t
  );
}
class ao {
...
class lo {
  constructor(e, t = () => !1) {
    if (($n(this, "eventsAwaitingConsent", []), null == e || !e.provider))
      throw new co(
  ...
  async do(e, t) {
    if (Kn(e)) {
      ...
      return this.isConsentGivenForEmission(n)
        ? (await this.processBufferedEvents(t), t(n))
        : this.isStrictlyNecessary(n)
        ? t(n)
        : (this.eventsAwaitingConsent.push(e),
          Promise.resolve({
            status: 0,
            message:
    ...
    }
    {
      if (
        this.isConsentGivenForEmission(
          await this.provider.annotateEvent(e.events[0])
        )
      ) {
        await this.processBufferedEvents(t);
        const n = await Promise.all(
          e.events.map((e) => this.provider.annotateEvent(e))
        );
        return t(Hn(Hn({}, e), {}, { events: n }));
      }
      const n = e.events.filter(
        (e) =>
          !!this.isStrictlyNecessary(e) ||
          (this.eventsAwaitingConsent.push(e), !1)
      );
      if (n.length > 0) {
        const o = await Promise.all(
          n.map((e) => this.provider.annotateEvent(e))
        );
        return t(Hn(Hn({}, e), {}, { events: o }));
      }
      return Promise.resolve({
        status: 0,
        message:
...
function uo(e, t) {
  ...
  if (
    "function" == typeof e &&
    void 0 !==
      (null === (n = e.toString) || void 0 === n ? void 0 : n.call(e)) &&
    (null === (o = e.toString) || void 0 === o ? void 0 : o.call(e)) ===
      (null === (r = t.toString) || void 0 === r ? void 0 : r.call(t))
  )
    return !0;
  if (e && t && "object" == typeof e && "object" == typeof t) {
    ...
    if (Array.isArray(e)) {
      ...
      for (o = n; 0 != o--; ) if (!uo(e[o], t[o])) return !1;
      return !0;
    }
      ...
      if ("3" == t)
        return (function (e) {
          ...
          return {
            v: "3",
            con: {
              CMP: { [bo]: c(bo), [wo]: c(wo), [yo]: c(yo), [xo]: c(xo) },
            },
            region: o || "",
            cus: s,
            purposes: { [go]: d(go), [mo]: d(mo), [vo]: d(vo), [_o]: d(_o) },
...
function jo() {
  ...
  return (
    Mo() && e.push("analytics"),
    Oo() && e.push("marketing"),
    To() && e.push("sale_of_data"),
    Co() && e.push("preferences"),
    e
  );
}
class Io extends so {
...
class No extends Error {
  constructor(e) {
    super(`Version ${e} is not supported by the consent-tracking-api provider`),
...
function Ao() {
  var e;
  const t =
    null === (e = n.querySelector("script#shop-js-analytics")) || void 0 === e
      ? void 0
      : e.innerHTML;
...
function Lo() {
  return y(this, void 0, void 0, function* () {
    let e;
    return Promise.race([
      new Promise((t) => (e = setTimeout(() => t({}), 1e4))),
      new Promise((e) => {
        var t, n, o;
        const r =
          (null ===
            (n =
              null === (t = c.ShopifyAnalytics) || void 0 === t
                ? void 0
                : t.lib) || void 0 === n
            ? void 0
            : n.ready) ||
          (null === (o = c.analytics) || void 0 === o ? void 0 : o.ready);
        null == r ||
          r(() => {
            var t, n, o, r;
            const i =
...
function Ro(...e) {
  return y(this, void 0, void 0, function* () {
    ...
    let n;
    Boolean(null === (t = c.trekkie) || void 0 === t ? void 0 : t.ready)
      ? (n = Lo())
      : ((c.trekkie = c.trekkie || []),
        (n = new Promise((e) => {
          c.trekkie.push([
...
var Do;
const zo = "unspecified",
  Uo = (function () {
    const e = new Io({ version: "v1" });
    return [new lo({ provider: e })];
  })(),
  Fo = [
    "completed",
    "emailsubmitted",
  ...
  $o = class e {
    ...
    static createHttpProducer(t) {
      return new e(
        t.production ? new ro(Wn, t.options) : new ro(Vn, t.options),
        t.middleware || []
      );
    }
    ...
    constructor(t, n) {
      (this.producer = t),
        ...
        (this.executeChain = e.buildMiddlewareChain(
          this.middleware.concat(new Xn(t))
        ));
    }
    produce(e) {
      return (
        (e.metadata = Hn(
          { eventCreatedAtMs: Date.now(), clientMessageId: Yn() },
          e.metadata
        )),
        this.executeChain(e)
      );
  ...
  }.createHttpProducer({ production: !0, middleware: Uo });
class Bo {
  constructor({
    analyticsData: e,
    devMode: t = !1,
    ...
    Do.set(this, void 0),
      ...
      w(
        ...
        Do,
        Object.assign(Object.assign({}, e), {
          flowVersion: null !== (r = e.flowVersion) && void 0 !== r ? r : zo,
        }),
        "f"
      ),
      (this.devMode = t),
      (this.notify = n),
      (this.recordCounter = o),
  ...
  set analyticsData(e) {
    const t = Object.assign(Object.assign({}, b(this, Do, "f")), e);
    uo(t, b(this, Do, "f")) || w(this, Do, t, "f");
  }
  ...
  produceMonorailEvent({ event: e, onError: t, trekkieAttributes: n }) {
    this.devMode ||
      (!n || Object.keys(n).length
        ? ((e.payload = Object.assign(e.payload, n)),
          $o.produce(e).catch((e) => {
            var n;
            if (
              (null == t || t(e),
              (function (e) {
                ...
                return !(
                  ...
                  (null === (t = null == e ? void 0 : e.message) || void 0 === t
                    ? void 0
                    : t.includes("Invalid agent:")) ||
                  (null === (n = null == e ? void 0 : e.message) || void 0 === n
                    ? void 0
                    : n.includes(".text is not a function")) ||
                  (null === (o = null == e ? void 0 : e.message) || void 0 === o
                    ? void 0
                    : o.includes(
                  ...
                  (null === (a = null == e ? void 0 : e.message) || void 0 === a
                    ? void 0
                    : a.match(
                        /(null|undefined) is not an object \(evaluating '[a-zA-Z]+\.status'\)/
                      )) ||
                  (null === (s = null == e ? void 0 : e.message) || void 0 === s
                    ? void 0
              ...
              const t =
                e instanceof Error
                  ? e
                  : new Mn(String(e), "MonorailProducerError");
              if (
                (null === (n = this.notify) || void 0 === n || n.call(this, t),
                this.recordCounter)
              ) {
                const e = (function (e) {
                  const t = Object.values(mn).find(([t, n]) =>
        ...
        : null == t || t({ message: "trekkie attributes are empty" }));
  }
  trackFeatureInitialization() {
    return y(this, void 0, void 0, function* () {
      ...
      this.featureInitializationEventAlreadyEmitted &&
        (null === (e = this.notify) ||
          ...
          e.call(
            this,
            new Mn(
              `Feature Initialize Event already emitted once for the feature ${s}`,
              "MonorailLogicError",
              r
            )
          ));
      const h = Ao(),
        f =
          null !== (t = null == h ? void 0 : h.pageType) && void 0 !== t
            ? t
            : "",
        m = yield Ro(
          "customerId",
        ...
        g = Object.assign(
          ...
          ),
          {
            ...
            shopPermanentDomain:
              null !==
                (o =
                  null === (n = c.Shopify) || void 0 === n ? void 0 : n.shop) &&
              void 0 !== o
                ? o
                : "",
            source: u,
      ...
      (this.produceMonorailEvent({
        event: {
          ...
          payload: {
            ...
            reason: n,
            zoom: `${
              null === (o = c.visualViewport) || void 0 === o ? void 0 : o.scale
            }`,
          },
        },
      }),
  ...
  trackPageImpression(e) {
    return y(
      ...
      function* ({
        ...
        const p = Ao(),
          h =
            null !== (i = null == p ? void 0 : p.pageType) && void 0 !== i
              ? i
              : "",
          f = yield Ro(
            "customerId",
  ...
  trackUserAction({ userAction: e }) {
    ...
    const u = Object.assign(
      ...
      ),
      {
        ...
        shopPermanentDomain:
          null !==
            (n = null === (t = c.Shopify) || void 0 === t ? void 0 : t.shop) &&
          void 0 !== n
            ? n
            : "",
        userAction: e,
  ...
  trackPostMessageTransmission({ direction: e, event: t }) {
    ...
    const r = Date.now(),
      ...
      c = (function (e) {
        ...
        ? t.email
        : void 0,
      d = { eventType: o, direction: e, actor: "shop-js" };
    null === (n = this.recordCounter) ||
      void 0 === n ||
      n.call(this, "shop_js_post_message_transmission", { attributes: d }),
      this.produceMonorailEvent({
        event: {
...
const Ho = ({
  ...
  const _ = Ne(
    ...
    [
      g.analyticsData,
      g.produceMonorailEvent,
      g.trackModalStateChange,
      g.trackPageImpression,
      g.trackUserAction,
      g.trackPostMessageTransmission,
    ]
  );
  return pe(Et.Provider, { value: _, children: r });
};
function Vo({ children: e }) {
  const { featureName: t } = Ot(),
    n = Ne(() => new hn({ exporter: gn() }), []),
    o = Ae(
      ({ body: e, attributes: o }) => {
        n.log({
          body: e,
          attributes: Object.assign({ beta: !0, feature: t }, o),
        });
      },
      [n, t]
    ),
    r = Ae(
      (e, o = {}) => {
        const { attributes: r, unit: i, value: a = 1 } = o;
        n.counter({
          attributes: Object.assign({ beta: !0, feature: t }, r),
          name: e,
          value: a,
          unit: i,
        });
    ...
    a = Ae(
      (e, o = {}) => {
        const { attributes: r, unit: i, value: a = 1, bounds: s } = o;
        n.histogram({
          attributes: Object.assign({ beta: !0, feature: t }, r),
          bounds: s,
          name: e,
  ...
  return pe(Pt.Provider, { value: s, children: e });
}
const Wo = "gravity-font-faces",
  qo = ({
    ...
    const p = Ne(
      () => ({ devMode: o, element: r, featureName: i, instanceId: u }),
      [o, r, i, u]
    );
    return pe(Ct.Provider, {
      ...
      children: pe(Ko, {
        ...
        children: pe(Un, {
          getFeatureDictionary: a,
          overrideLocale: d,
          children: pe(Xo, { enabled: e, children: t }),
        }),
      }),
    });
  };
function Ko({ children: e, enabled: t = !0, monorailProps: n }) {
  return t
    ? pe(En, {
        children: pe(Cn, {
          children: pe(Vo, {
            children: pe(Ho, Object.assign({}, n, { children: e })),
          }),
        }),
      })
    : pe(B, { children: e });
}
function Xo({ children: e, enabled: t = !0 }) {
  return t ? pe(It, { children: e }) : e;
}
const Yo = () => Le(Nn),
  Go = ["string", void 0],
  Jo = () => {
    const { locale: e, translations: t } = Yo();
    return {
      locale: e,
      translate: (n, o) => {
        const r = n.split(".");
        ...
        try {
          ...
          if ("string" != typeof t && a) {
            let e = 1 === a ? "one" : "other";
            0 === a && "string" != typeof t && "zero" in t && (e = "zero"),
              (c = c[e]);
          }
          ...
          return (
            n.forEach((t) => {
              e || Go.includes(typeof l[t]) || (e = !0),
                o.forEach((e, n) => {
                  e === `{${t}}` && (o[n] = l[t]);
                });
            }),
            e ? pe(B, { children: o }) : o.join("")
          );
        } catch (e) {
          return s || n;
        }
...
const Qo = c.HTMLElement,
  ...
  nr = {
    boolean: {
      stringify: (e) =>
        "" === e ? "true" : e ? /^[ty1-9]/i.test(e).toString() : "false",
      parse: (e, t, n) =>
        "" === e || (e ? /^[ty1-9]/i.test(e) : n.hasAttribute(t) && null === e),
    },
    function: {
      stringify: (e) =>
        "function" == typeof e
          ? e.name.replace("bound ", "")
          : "string" == typeof e
          ? e.replace("bound ", "")
          : e,
      parse: (e, t, n) => {
...
function or(e, { methods: t, name: n, props: o, shadow: r }) {
  var i;
  if ("undefined" == typeof window) return;
  const { notify: a } = new kn(n);
  function s() {
    const t = ((e) => er(() => Reflect.construct(HTMLElement, [], e)))(s);
    if (
      ((t._eventListenerReadyPromise = new Promise((e) => {
        t._eventListenerReadyPromiseResolve = e;
      })),
      (t._vdomComponent = e),
      (t._root = r ? t.attachShadow({ mode: r }) : t),
      r)
    ) {
      const e = new CSSStyleSheet();
  ...
  Object.entries(o || {}).forEach(([e, t]) => {
    const n = Pn(e);
    l.set(n, { attribute: n, preactProp: e, type: t });
  });
  const c = Array.from(l.values()).map(({ attribute: e }) => e);
  function d(e) {
    this.getChildContext = () => e.context;
    const { context: t, children: n } = e;
  ...
  function p(e, t) {
    ...
    const n = {},
      o = [],
      { childNodes: r } = e;
    l.forEach(({ attribute: t, preactProp: o, type: r }) => {
      const i = nr[r],
        a = e.getAttribute(t);
      let s = a;
      ("boolean" === r || a) && (s = i.parse(a, t, e)),
        null !== s && ((n[t] = s), (n[o] = s));
    });
    for (const e of r) {
      const t = p(e, null);
  ...
  (s.prototype = Object.create(HTMLElement.prototype)),
    ...
    (s.observedAttributes = c),
    (s.prototype.attributeChangedCallback = function (e, t, n) {
      if (!this._vdom) return;
      const o = l.get(e);
      if (!o) return;
      const { preactProp: r, type: i } = o,
        a = nr[i],
        s = {};
      if (n || "boolean" !== i) {
        if (i && n) {
    ...
    (s.prototype.connectedCallback = function () {
      ...
      (this._vdom = F(
        ...
        p(this, this._vdomComponent)
      )),
        le(this._vdom, this._root);
    }),
    null == t ||
      t.forEach((e) => {
        s.prototype[e] = function (t) {
          this._eventListenerReadyPromise
            ...
            .catch(() => {
              a(
                new Mn(
                  `Custom element ${n}: Error listening for methods`,
    ...
    l.forEach(({ attribute: e, type: t }) => {
      ...
      Object.defineProperty(s.prototype, e, {
        ...
        set(o) {
          let r = o;
          this._vdom
            ? this.attributeChangedCallback(e, null, o)
            : (("boolean" === t || o) && (r = n.parse(o, e, this)),
              this._props || (this._props = {}),
              (this._props[e] = r),
              this.connectedCallback()),
            this.setAttribute(e, n.stringify(r));
        },
      });
    });
  return customElements.get(n)
    ? void 0
    : (null === (i = Reflect.defineProperty) ||
        void 0 === i ||
        i.call(Reflect, s, "componentVersion", { value: "preact" }),
      ((e, t) => {
        er(() => {
...
function ir(...e) {
  return e
    .map((e) =>
      "object" == typeof e && "string" == typeof (null == e ? void 0 : e.value)
        ? e.value
        : e
    )
...
const sr = (function (e) {
    const t = (function (e) {
      if (e.match(/\.shop\.dev$/) && "web-shop-client.shop.dev" !== e)
        return "shop.dev";
    })(e.hostname);
    return t
      ? {
...
function hr(e) {
  return (
    !("string" != typeof e || !e) && RegExp(/^[^@]+@[^@]+\.[^@]{2,}$/i).test(e)
  );
}
function fr({ allowedOrigins: e, destination: t = c, handler: n, source: o }) {
  const { trackPostMessageTransmission: r } = St(),
    i = Ne(() => new Set(), []);
  Oe(
    () => (
      i.add(n),
    ...
    Oe(() => {
      const e = (e) =>
        ...
        })(e) && r({ direction: "incoming", event: e });
      return (
        i.add(e),
        () => {
          i.delete(e);
  ...
  const a = Ae(
    ...
    s = Ae(
      (t) => {
        const n =
          o.current instanceof HTMLIFrameElement
            ? o.current.contentWindow
            : o.current;
        (function (e, t) {
          return e.source === t;
        })(t, n || null) &&
          (e.some((e) => pr(e, t.origin))
            ? a(t.data)
            : console.error("Origin mismatch for message event", t));
      },
      [e, a, o]
    ),
    l = Ae(() => {
    ...
    (e, t) =>
      y(this, void 0, void 0, function* () {
        ...
        return new Promise((o, r) => {
          ...
          (null == t ? void 0 : t.aborted) && a(),
            (n = (n) => {
              n.type === e &&
                (null == t || t.removeEventListener("abort", a), o(n));
            }),
            i.add(n),
            null == t || t.addEventListener("abort", a);
        }).finally(() => {
          i.delete(n);
        });
      }),
  ...
  return { destroy: l, waitForMessage: d };
}
function mr(e) {
  var { includeCore: t, source: n, storefrontOrigin: o } = e,
    r = _(e, ["includeCore", "source", "storefrontOrigin"]);
  const i = ur(),
    a = Ae(
      (e) =>
        y(this, void 0, void 0, function* () {
          ...
          switch (e.type) {
            ...
            case "loaded":
              i("loaded", e),
                "loginTitle" in e ? null == p || p(e) : null == h || h(e);
              break;
            case "unloaded":
              null == M || M(e);
              break;
...
const gr = "temporarily_unavailable",
  vr = "Shop login is temporarily unavailable";
function _r() {
  const e = ur(),
    t = je(null),
    n = Ae(() => {
...
function br({ contentWindow: e, event: t, onMessageSent: n }) {
  if (!e) return;
  const o = [cr, dr],
    r = Object.assign(Object.assign({}, t), { messageId: s() });
  o.forEach((t) => {
    e.postMessage(r, t);
  }),
    null == n || n(r);
...
const Er = ({ className: e, headerTitle: t, headerLogo: n, onDismiss: o }) => {
    const { translate: r } = Jo(),
      i = Boolean(t),
      a = i ? "with-title" : "default";
    return pe("div", {
      className: ir(
      ...
      children: [
        ...
        pe("button", {
          "aria-label": r("button.close", { defaultValue: "Close" }),
          className:
            "group relative z-50 flex size-6 cursor-pointer rounded-max",
...
const Pr = Xe((e, t) => {
    var { as: n = "div", children: o, disabled: r = !1 } = e,
      i = _(e, ["as", "children", "disabled"]);
    const a = je(null),
      s = je(null),
      l = je(null);
    Te(() => {
    ...
    return pe(B, {
      children: [
        pe("div", { className: u, ref: s, onFocus: () => c(!1), tabIndex: d }),
        pe(
          n,
          Object.assign({}, i, {
            ref: (e) => {
        ...
        pe("div", { className: u, ref: l, onFocus: () => c(!0), tabIndex: d }),
      ],
    });
  }),
  Mr = "e_db171811ef21b52a48282dfe9378529b",
  Cr = ({
    anchorTo: e,
    children: t,
    headerLogo: o,
    ...
    const { dispatch: d, modalDismissible: u } = ar(),
      p = je(null),
      h = je(null),
      [f, m] = Me(null),
      [g, v] = Me(null),
    ...
    Oe(() => {
      ...
      const e = () => y(!0),
        t = p.current;
      return (
        null == t || t.addEventListener("transitionend", e, { once: !0 }),
        () => {
      ...
      Oe(() => {
        ...
        const o =
          null == t
            ? void 0
            : t.closest('[id="contact-information-text-field-container"]');
        m(t), v(o);
      }, [e]),
      Oe(() => {
        if (g && !b)
          return (
            g.style.setProperty("opacity", l ? "0" : "1"),
            () => {
              g.style.removeProperty("opacity");
            }
          );
      }, [g, b, l]),
      Tr({ emailInputElement: f, setShimmering: w, visible: l });
    const {
    ...
    Or({ resizeObserver: C, elementRef: g, setHeight: M }),
      Or({ resizeObserver: O, elementRef: h.current, setHeight: S }),
      Or({ resizeObserver: T, elementRef: p.current, setHeight: k });
    const j = Ae(
        (e) => {
          u && s(e);
        },
  ...
  Or = ({ resizeObserver: e, elementRef: t, setHeight: n }) => {
    Oe(() => {
      if (e && t)
        return (
          e.observe(t),
  ...
  Tr = ({ emailInputElement: e, setShimmering: t, visible: o }) => {
    Oe(() => {
    ...
    const r = Ae(() => {
        e &&
          ...
          e.style.setProperty("background-size", "300% 100%"),
          e.style.setProperty("background-clip", "text"),
          e.style.setProperty("background-color", "transparent"),
          e.style.setProperty("color", "transparent"),
          e.style.setProperty("caret-color", "var(--x-default-color-text)"),
          e.style.setProperty("animation", "shimmer 3000ms ease-out"));
      }, [e, t]),
      i = Ae(() => {
        e &&
          (t(!1),
...
function Ir() {
  const e = jr.mobile.every((e) => c.matchMedia(`(${e})`).matches),
    t = !e && jr.tablet.every((e) => c.matchMedia(`(${e})`).matches);
  return { isMobile: e, isTablet: t, isDesktop: !e && !t };
}
function Nr() {
  return (
    (Boolean(Bt.userAgent) &&
      /(android|iphone|ipad|mobile|phone)/i.test(Bt.userAgent)) ||
    (function () {
      const e = Bt.userAgent.toLowerCase();
      return e.includes("fban/fbios") || e.includes("fb_iab/fb4a");
    })() ||
    Bt.userAgent.toLowerCase().includes("instagram") ||
    Bt.userAgent.toLowerCase().includes("messenger") ||
    (function () {
      const e = Bt.userAgent;
      return RegExp(Rr).test(e) || RegExp(Dr).test(e);
    })() ||
...
function Lr() {
  return Boolean(
    "undefined" != typeof IntersectionObserver && IntersectionObserver
  );
}
const Rr =
...
const Ur = Xe((e, t) => {
  var { children: n, className: o, disableTransition: r = !1 } = e,
    i = _(e, ["children", "className", "disableTransition"]);
  return pe(
    "button",
    Object.assign({}, i, {
      className: ir(
...
const Fr = Xe((e, t) => {
  ...
  return pe(
    ...
    Object.assign({}, s, {
      className: ir(
        "m-auto",
        n ? "border border-solid border-white/20" : "border-none",
        a ? "w-full justify-center" : void 0,
        o
      ),
      ref: t,
      children: pe("span", {
...
function $r() {
  return pe(zr, {
    className:
      "flex aspect-branded-button-icon h-branded-button-icon w-auto translate-y-[9.375%] self-center",
  });
}
(Fr.displayName = "BrandedButton"), ($r.displayName = "BrandedButtonIcon");
const Br = ({ defaultUxMode: e, uxMode: t }) =>
    Ne(() => {
      const n = Nr();
...
function Vr({
                  ...
                  Object.assign(
                    {
                      ...
                      compact_layout: Hr(b),
                      consent_challenge: Hr(u),
                      ctx: p,
                      "customize-modal": Hr(E),
                      embed: f,
                    },
                    m && { error: m }
                  ),
  ...
  return (
    Object.keys(Z).forEach((e) => void 0 === Z[e] && delete Z[e]),
    new URLSearchParams(Z)
  );
}
function Wr(e) {
  const t = Vr(e),
    ...
    o = {},
    r = {};
  "none" === e.prompt && (o.sso = "silent"),
    "windoid" === e.uxMode && (o.display = e.returnTo ? "redirect" : "popup");
  for (const [e, i] of t.entries()) n.has(e) ? (o[e] = i) : (r[e] = i);
  return (
    Object.keys(r).length > 0 &&
      (o.shop_params = new URLSearchParams(r).toString()),
...
function qr(e) {
  ...
  if (
    (function (e) {
      return (
        "loginWithShopSelfServe" === e.analyticsContext &&
        "iframe" !== e.uxMode &&
        "prompt" !== e.uxRole
      );
    })(e)
  )
    return `${cr}/oauth/authorize?${t}`;
...
function Kr(e) {
  ...
  const { locale: g } = Yo(),
    ...
    y = Ae(
      (e) => {
        if ("prompt" === (null == e ? void 0 : e.uxRole) && !a && s)
          return (function ({
            analyticsTraceId: e,
            clientId: t,
            flow: n,
  ...
  return Ae(
    (o) =>
      y(
        ...
        [o],
        void 0,
        function* ({ loggedIn: o, shouldFinalizeLogin: r, redirectUri: i }) {
          o && r && (yield Xr(e, t)),
            i &&
              (!(function (e) {
                try {
                ...
                ? n({
                    ...
                    attributes: { redirectUri: i, storefrontOrigin: e },
                  })
                : (c.location.href = i));
        }
      ),
...
function Gr() {
  ...
  (o.id = e),
    ...
    (o.style.bottom = "-1000px"),
    (o.style.right = "-1000px"),
    (o.style.transform = "translate(1000px, 1000px)"),
...
function Jr({
  ...
  const { loaded: s, modalVisible: l } = ar(),
    { leaveBreadcrumb: c, notify: d } = wt(),
    { trackUserAction: u } = St(),
    { isFilledWithPasswordManager: p } = (function ({ emailInputSelector: e }) {
      const [t, o] = Me(),
        [r, i] = Me();
      return (
        Oe(() => {
        ...
        {
          isFilledWithPasswordManager: Ne(
            () => void 0 !== t && void 0 !== r && Math.abs(t - r) < 100,
            [t, r]
          ),
        }
      );
    ...
    E = Ae(
      (e, ...t) =>
        y(this, [e, ...t], void 0, function* (e, t = "", n = "") {
          var o, a;
          const f = hr(e);
          if (
            (p &&
              !k.has("PASSWORD_MANAGER_AUTOFILL_DETECTED") &&
              (k.add("PASSWORD_MANAGER_AUTOFILL_DETECTED"),
              u({ userAction: "PASSWORD_MANAGER_AUTOFILL_DETECTED" })),
            f &&
              !k.has("EMAIL_ENTERED") &&
              (k.add("EMAIL_ENTERED"), u({ userAction: "EMAIL_ENTERED" })),
            c("email entered", {}, "state"),
            !i.current || l)
          )
            return;
          if (!s) return;
          ...
          try {
            const { open: e, postMessage: o, waitForMessage: s } = i.current;
            (x.current = g),
              o({ firstName: t, lastName: n, type: "namesubmitted" }),
              o({
                email: g,
                hideChange: void 0 === r ? g.length > 0 : r,
                type: "emailsubmitted",
              }),
              c("email submitted", { email: g ? "redacted" : "" }, "state");
                ...
                const n = () =>
                  y(this, void 0, void 0, function* () {
                    try {
                      ...
                      "error" === t.type && "captcha_challenge" === t.code
                        ? e(void 0)
                        : yield n();
                    } catch (e) {
                      t(e);
            ...
            yield Promise.race([l, d]),
              e("event_shop_user_matched"),
              null === (a = null == w ? void 0 : w.current) ||
                void 0 === a ||
                a.blur(),
              Gr(),
              h.current.abort(),
            ...
            if (e instanceof Mn && "AbortSignalReceivedError" === e.name)
              return;
            e instanceof Error &&
              d(
                new Error(`Error updating user info: ${e.name} - ${e.message}`)
              );
          }
        }),
      [r, i, p, c, s, l, d, u, k]
  ...
  Oe(() => {
    ...
    Oe(() => {
      ...
      if (((null == e ? void 0 : e.value) && r(), a))
        return (
          null == e || e.addEventListener("input", r),
          () => {
...
const Zr = ({
      ...
      (s) =>
        y(void 0, void 0, void 0, function* () {
          ...
          switch (s.data.type) {
            case "completed":
              yield t(s.data),
                a("completed", s.data, !0),
                null === (l = r.current) || void 0 === l || l.close();
              break;
            case "custom_flow_side_effect":
              yield null == i ? void 0 : i(s.data);
              break;
            case "error":
              yield null == n ? void 0 : n(s.data),
                a("error", s.data),
                null === (c = r.current) || void 0 === c || c.close();
              break;
            case "windoidopened":
            ...
            case "windoidclosed":
              a("windoidclosed"),
                yield null == e ? void 0 : e(),
                null === (d = r.current) || void 0 === d || d.close();
              break;
            case "prequal_buyer_upsert_successful":
              null === (u = r.current) || void 0 === u || u.close(),
                a("buyerOnboardingSuccess");
          }
        }),
      [a, t, e, i, n, o, r]
    );
  },
  Qr = ({ getAuthorizeUrl: e, getEmail: t, iframeRef: n, openWindoid: o }) => {
    const { trackUserAction: r } = St();
    return Ae(() => {
      var i;
      r({ userAction: "SIGN_IN_WITH_SHOP_PROMPT_CONTINUE_CLICK" }),
        null === (i = null == n ? void 0 : n.current) ||
          void 0 === i ||
          i.close({
            dismissMethod: "windoid_continue",
      ...
      const a = t(),
        s = e(
          Object.assign(Object.assign({}, a && { loginHint: a }), {
  ...
  ti = (e, t, o = "SignInWithShop") => {
    ...
    null === (r = ei[o]) || void 0 === r || r.call(ei);
    const a = c.open(
        e,
        "SignInWithShop",
        `popup,width=${i.width},height=${i.height},top=${i.top},left=${i.left}`
      ),
      s = () =>
        ((e) => {
          null == e || e.close();
        })(a);
    t(new MessageEvent("message", { data: { type: "windoidopened" } }));
    const l = setInterval(() => {
      (null == a ? void 0 : a.closed) &&
        (t(new MessageEvent("message", { data: { type: "windoidclosed" } })),
        clearInterval(l));
    }, 200);
    return (
...
function ri() {
  ...
  return e.loaded || "card" !== e.localPresentationMode
    ? t
      ? pe("span", {
          className: ir(
            "block w-full text-center text-caption data-hidden_invisible",
            "dark" === e.parentTheme ? "text-grayscale-l1" : "text-grayscale-d0"
          ),
    ...
    : pe("div", {
        ...
        children: [
          pe("div", {
            className:
              "my-0.5 h-3 w-full animate-pulse rounded-sm bg-grayscale-l2 motion-reduce_animate-none",
          }),
          pe("div", {
            className:
              "my-0.5 h-3 w-44 animate-pulse rounded-sm bg-grayscale-l2 motion-reduce_animate-none",
          }),
        ],
      });
}
function ii({ text: e, url: t }) {
  return pe("a", {
    className:
      "m-0 inline cursor-pointer appearance-none border-none bg-none p-0 underline hover_opacity-70 focus_opacity-70 active_opacity-70",
    href: t,
    target: "_blank",
...
function ai({ className: e, color: t, processing: n = !1 }) {
  return pe("div", {
    className: ir(
    ...
    children: pe("svg", {
      ...
      children: pe("path", {
        className:
          "animate-reveal will-change-transform stroke-dasharray-reveal stroke-dashoffset-reveal",
...
const si = Xe(({ children: e, onClick: t, visible: n = !0 }, o) => {
  const { state: r } = oi();
  return pe("div", {
    className: ir("relative", !n && "invisible hidden"),
    "data-testid": "login-button-container",
    children: [
      pe(Fr, {
        buttonClassName: ir(
          "dark" === r.parentTheme && "shadow-sm",
          r.processing && "pointer-events-none"
        ),
...
function li({ children: e, onClick: t }) {
  const n = je(null),
    o = je(null),
    r = je(null),
    { state: i } = oi(),
  ...
  }, [i.localPresentationMode, i.footerPolicy]),
    Oe(() => {
      const e = n.current;
      if (!e) return;
      const t = (e) => {
      ...
      return (
        ...
        () => {
          null == e || e.removeEventListener("transitionstart", t),
            null == e || e.removeEventListener("transitionend", o);
        }
      );
  ...
  return pe("div", {
    ...
    ref: n,
    style: { height: void 0 === u ? "auto" : `${u}px` },
    children: pe("div", {
      className: "relative flex w-full flex-col space-y-3 pt-3",
      ref: o,
      children: [pe(si, { onClick: t, ref: r, children: e }), pe(ri, {})],
    }),
  });
}
function ci() {
  ...
  return pe("div", {
    ...
    children: pe("div", {
      className:
        "group relative h-4 flex-shrink-0 overflow-hidden transition-all duration-300 ease-out motion-reduce_transition-none",
      "data-testid": "shop-logo-width-aware-container",
      "data-visible": o,
      style: {
        "--shop-logo-container-width": `${
          null === (e = t.current) || void 0 === e ? void 0 : e.offsetWidth
        }px`,
        width: o ? "var(--shop-logo-container-width)" : "0px",
      },
      children: pe("div", {
        className:
          "aspect-branded-button-icon h-4 translate-x-0 opacity-100 transition-all duration-300 group-data-hidden_translate-x-full group-data-hidden_opacity-0 motion-reduce_transition-opacity",
        "data-testid": "shop-logo-container",
        ref: t,
        children: pe(zr, { className: "h-4 text-purple-primary" }),
      }),
    }),
  });
}
si.displayName = "LoginButton";
const di = Xe(({ src: t, storefrontOrigin: n }, o) => {
  const { leaveBreadcrumb: r, notify: i } = wt(),
    a = ur(),
    { clearLoadTimeout: s, initLoadTimeout: l } = _r(),
    { recordCounter: c } = Mt(),
    { dispatch: d, state: u } = oi(),
    p = je(null),
    { loaded: h, localPresentationMode: f, processing: m } = u,
    g = Ae(() => {
      xr({ iframe: p.current, src: t });
    }, [t]),
    { destroy: v, waitForMessage: _ } = mr({
      includeCore: !0,
      onError: (t) => {
        const { message: n, code: o } = t;
        e(o, n)
          ? (r("shop login iframe error", { code: o, message: n }, "state"),
            i(new Mn(n, "ShopLoginIframeError")))
          : (c("shop_js_handle_silent_error", { attributes: { errorCode: o } }),
            r("silent error", { code: o }, "state")),
          s();
      },
      onLoaded: ({
        consented: e,
      ...
      onShopUserMatched: ({ userCookieExists: e }) => {
        d({ payload: { userCookieExists: e }, type: "userMatched" });
      },
  ...
  const b = Ae(
    (e, t) =>
      y(void 0, void 0, void 0, function* () {
        var n;
        Boolean(null == t ? void 0 : t.afterLoaded) &&
          !h &&
          (yield _("loaded")),
          br({
            contentWindow:
  ...
  Ie(
    o,
    () => ({ iframeRef: p, postMessage: b, reload: g, waitForMessage: _ }),
    [b, g, _]
  ),
    Oe(() => {
      l(), r("Iframe url updated", { src: t }, "state");
    }, [l, r, t]),
    Oe(() => {
      xr({ iframe: p.current, src: t });
    }, [t]);
  return pe("div", {
    className:
      "pointer-events-none flex w-full flex-grow flex-row items-center justify-start gap-x-1 overflow-hidden",
    children: [
      pe("div", {
        className:
          "relative block min-w-0 flex-grow overflow-hidden opacity-100 data-hidden_opacity-0",
        "data-testid": "recognition-iframe-wrapper",
        "data-visible": Ne(() => "button" !== f || !m, [f, m]),
        children: [
          pe("div", {
            className:
              "group flex w-full items-center gap-2 opacity-100 data-hidden_absolute data-hidden_inset-0 data-hidden_opacity-0",
            "data-testid": "recognition-iframe-skeleton",
            "data-visible": !h,
            children: [
              pe("div", {
                className:
                  "size-8 animate-pulse rounded-max bg-grayscale-l2 ring-1 ring-inset ring-black/5 group-data-hidden_animate-none motion-reduce_animate-none",
              }),
              pe("div", {
                ...
                children: [
                  pe("div", {
                    className:
                      "my-0.5 h-[14px] w-16 animate-pulse rounded-sm bg-grayscale-l2 group-data-hidden_animate-none motion-reduce_animate-none",
                  }),
                  pe("div", {
                    className:
                      "my-px h-3 w-37 animate-pulse rounded-sm bg-grayscale-l2 group-data-hidden_animate-none motion-reduce_animate-none",
                  }),
                ],
              }),
            ],
          ...
          pe("iframe", {
            className:
              "relative z-40 max-h-8 w-full overflow-hidden border-none opacity-100 data-hidden_absolute data-hidden_inset-0 data-hidden_opacity-0",
            "data-testid": "recognition-iframe",
            "data-visible": h,
            ref: (e) => {
              e &&
                ((p.current = e),
                e.getAttribute("src") || e.setAttribute("src", t));
            },
            scrolling: "no",
            tabIndex: 0,
          }),
          pe("div", {
            className:
              "absolute inset-y-0 right-0 z-50 w-1 bg-gradient-to-r from-transparent to-white opacity-100 data-hidden_opacity-0",
            "data-visible": "button" === u.localPresentationMode,
          }),
        ],
      }),
      "button" === f && pe(ai, { color: "purple", processing: m }),
      pe(ci, {}),
    ],
  });
});
di.displayName = "LoginIframe";
const ui = Xe(({ children: e, iframeUrl: t, onClick: n, visible: o }, r) => {
    const i = je(null),
      a = je(null),
      { state: s, flowVersion: l } = oi();
    Oe(() => {
      var e;
      const t = (e) => {
    ...
    const c =
      "button" === s.localPresentationMode
        ? { onClick: n, role: "button", tabIndex: 0 }
        : {};
    return (
      Ie(r, () => ({ iframe: a }), []),
      pe(
        ...
        Object.assign(
          {
            ...
            className: ir(
              ...
              "account_menu" !== l && "backdrop-blur-xl",
              "button" === s.localPresentationMode
          ...
          c,
          {
            ...
            children: pe("div", {
              className: ir(
                ...
                "button" === s.localPresentationMode ? "p-shop-login" : "p-4"
              ),
              "data-testid": "login-recognition-content",
              children: [
                pe(di, { ref: a, src: t }),
                pe(li, { onClick: n, children: e }),
              ],
            }),
          }
        )
...
function hi(e, t) {
  switch (t.type) {
    ...
    case "setProcessing":
      return Object.assign(Object.assign({}, e), { processing: t.payload });
    case "userMatched":
      return Object.assign(Object.assign({}, e), {
...
function fi({
  ...
  const r = ur(),
    { analyticsData: i, produceMonorailEvent: a, trackUserAction: s } = St(),
    { log: l, recordCounter: d, recordHistogram: u } = Mt(),
    p = je(!1),
    h = je(!1),
    f = Ne(
      () =>
    ...
    m = Ae(
      (e) => {
        const { analyticsTraceId: t, flowVersion: n } = i;
        a({
          event: {
            schemaId: "shop_identity_presentation_mode_change/1.0",
            payload: Object.assign({ analyticsTraceId: t, flowVersion: n }, e),
          },
        });
      },
      [i, a]
    ...
    g = Ae(
      ({ action: e, previousState: t, state: n }) => {
        switch (e.type) {
          case "iframeLoaded": {
            if (
              (r("loaded", {
              ...
              break;
            const o =
                "card" === t.localPresentationMode &&
                "button" === n.localPresentationMode &&
                !e.payload.userFound,
              i =
                "button" === t.localPresentationMode &&
                "button" === n.localPresentationMode &&
                e.payload.userFound;
            if (
              ((h.current = !0),
              n.mountedTimestamp
                ? u("shop_js_iframe_load_duration", {
                    attributes: { flowVersion: f },
          ...
          case "userMatched":
            r("shop_user_matched", { presentation: n.localPresentationMode }),
              r("lookup_end"),
              m({
                currentMode: "card",
                previousMode: "button",
      ...
      (e, n) => {
        ...
        if ("iframeLoaded" === n.type) {
          const r = (function ({
            ...
            a = hi(e, i);
          return g({ action: i, previousState: o, state: a }), a;
        }
        const r = hi(e, n);
        return g({ action: n, previousState: o, state: r }), r;
      },
      [t, g]
    ),
    [_, y] = Ce(
      v,
      (function ({ presentationMode: e = "button", textVariant: t }) {
        var n;
        let o;
        try {
          o =
            null !==
              (n = new URL(c.location.href).searchParams.get("login_hint")) &&
            void 0 !== n
              ? n
              : void 0;
        } catch (e) {
      ...
      })({ presentationMode: t, textVariant: o })
    );
  Oe(() => {
    p.current ||
      ((p.current = !0),
      d("shop_js_feature_initialized", { attributes: { flowVersion: f } }));
  }, [f, d]);
  const b = Ae(
      (e) => {
        s({ userAction: e }),
          d("shop_js_user_action", {
            attributes: { action: e, flowVersion: f },
          });
      },
      [f, d, s]
    ),
    w = Ne(
      () => ({ dispatch: y, flowVersion: f, state: _, trackUserAction: b }),
      [y, f, _, b]
    );
  return pe(ni.Provider, { value: w, children: e });
}
function mi(e, t) {
  const n = _i(e),
    o = _i(t);
...
function vi(e) {
  ...
  const o =
    null ===
      (t = c.getComputedStyle(e).getPropertyValue("--color-background")) ||
    void 0 === t
      ? void 0
      : t.trim();
  if (o) return o;
...
function wi(e) {
  let t;
  if (
    (e.startsWith("#") && (t = gi(e)), e.startsWith("rgb(") && (t = yi(e)), !t)
  )
    return !1;
  const n = (function (e) {
    ...
    (function (e) {
      return 0.2126 * bi(e[0]) + 0.7152 * bi(e[1]) + 0.0722 * bi(e[2]);
    })([t[0] / 255, t[1] / 255, t[2] / 255])
  );
  return n < 50;
}
function xi(e) {
  const { recordCounter: t } = Mt();
  return Ne(() => {
    try {
      if (
        e &&
      ...
      e instanceof Error &&
        t("shop_js_invalid_storefront_origin", { attributes: { error: e } });
    }
    return c.location.origin;
  }, [e, t]);
}
function ki({ source: e }) {
  const { notify: t } = wt(),
    { recordCounter: n } = Mt(),
    o = Ae(
      (e) => {
        "completed" === e.type &&
          (n("shop_js_cart_sync_finalize_fetch"),
          (function ({ onError: e, onResolve: t }) {
            fetch(
              `${c.location.origin}/services/login_with_shop/buyer/finalize`
            )
              .then((e) => t(e.status))
              .catch((t) => e(t));
          })({
    ...
    if (!i)
      return (
        t({
          ...
          attributes: { analyticsTraceId: o, domain: c.location.origin },
        }),
        ""
      );
    if (null === (n = c.Shopify) || void 0 === n ? void 0 : n.designMode)
      return "";
    const a = new URLSearchParams({
...
or(
  (e) => {
    ...
    return pe(qo, {
      ...
      children: pe(Ei, Object.assign({}, n)),
    });
  },
  { name: "shop-cart-sync", shadow: "open" }
);
const Si = (e) => {
...
function Pi({
  ...
  if (i) {
    const e = i.split(",").map((e) => {
        const [t, n] = e.split(":"),
          o = n ? Number(n) : 1;
        return { id: Number(t), quantity: isNaN(o) ? 1 : o };
      }),
  ...
  return (
    l.append("payment", t || "shop_pay"),
    n && l.append("source", n),
    o && l.append("source_token", o),
    e && l.append("channel", e),
    `${s.href}?${l}`
  );
}
function Mi(e, t) {
  Boolean(c.customElements) &&
    (c.Shopify || (c.Shopify = {}),
    c.Shopify.SignInWithShop || (c.Shopify.SignInWithShop = {}),
    (c.Shopify.SignInWithShop[e] = t));
}
function Ci() {
  var e;
  const t =
    null === (e = n.querySelector("script#shop-js-features")) || void 0 === e
      ? void 0
      : e.innerHTML;
  return t ? JSON.parse(t) : {};
}
...
function Ti(e) {
  return y(
    ...
    function* (
      e,
      t = {},
      { maxRetries: n = 3, retryDelay: o = 1e3, signal: r } = {}
    ) {
      try {
        ...
        if (n - 1 > 0)
          return (
            ...
            (null == r ? void 0 : r.aborted)
              ? Promise.reject(Oi)
              : Ti(e, t, { maxRetries: n - 1, retryDelay: o, signal: r })
          );
        throw i;
      }
    }
...
const Ni = (e) =>
  y(void 0, void 0, void 0, function* () {
    if (!("IdentityCredential" in c)) throw new ji();
    const {
    ...
    if (!a)
      throw (
        (null == o || o.trackUserAction({ userAction: "FEDCM_CANCELLED" }),
        new Ii())
      );
    return (function (e, t, n) {
      return y(this, void 0, void 0, function* () {
        try {
          ...
          return (
            null == n || n.trackUserAction({ userAction: "FEDCM_COMPLETED" }), o
          );
        } catch (e) {
          throw new Mn(
...
function Ai({ onElementFound: e, selector: t }) {
  const o = new WeakSet(),
    ...
    (function () {
      y(this, void 0, void 0, function* () {
        yield (function () {
          ...
          i(),
          r.observe(n.body || n.documentElement, {
            childList: !0,
            subtree: !0,
          });
      });
...
function Li({ onFallback: e, onVisible: t }) {
  const n = new IntersectionObserver(
    (r) => {
      for (const i of r) {
        const { isIntersecting: r, target: a } = i;
  ...
  constructor(e, t) {
    Ri.set(this, void 0),
      ...
      e &&
        ...
        b(this, Ri, "f").addEventListener("input", b(this, Di, "f")));
  }
  destroy() {
    b(this, Ri, "f") &&
      b(this, Di, "f") &&
      b(this, Ri, "f").removeEventListener("input", b(this, Di, "f"));
  }
}
(Ri = new WeakMap()), (Di = new WeakMap());
const Ui = "shop-toast-manager";
function Fi(e) {
  let t = n.querySelector(Ui);
  t || ((t = n.createElement(Ui)), n.body.appendChild(t)),
    customElements
      .whenDefined(Ui)
      .then(() => {
        t.renderToast(e);
...
//# sourceMappingURL=chunk.common_DH6hE_eH.esm.js.map
