import {
  ...
  z as S,
  B as z,
} from "./chunk.common_DH6hE_eH.esm.js";
const I = Math.min,
  F = Math.max,
  H = Math.round,
  j = Math.floor,
...
async function ne(e, t) {
  var n;
  void 0 === t && (t = {});
  const { x: o, y: r, platform: i, rects: l, elements: s, strategy: a } = e,
    {
    ...
    g = ee(
      await i.getClippingRect({
        element:
          null == (n = await (null == i.isElement ? void 0 : i.isElement(h))) ||
          n
            ? h
            : h.contextElement ||
    ...
    y =
      "floating" === d
        ? { x: o, y: r, width: l.floating.width, height: l.floating.height }
        : l.reference,
...
function le(e) {
  var t;
  return null == (t = (se(e) ? e.ownerDocument : e.document) || window.document)
    ? void 0
    : t.documentElement;
}
function se(e) {
...
function ue(e) {
  return (
    !(!oe() || "undefined" == typeof ShadowRoot) &&
    (e instanceof ShadowRoot || e instanceof ie(e).ShadowRoot)
  );
}
function de(e) {
  const { overflow: t, overflowX: n, overflowY: o, display: r } = ye(e);
  return (
...
function Ee(e) {
  ...
  const r = ce(e),
    ...
    s = H(n) !== i || H(o) !== l;
  return s && ((n = i), (o = l)), { width: n, height: o, $: s };
}
function Re(e) {
...
function Me(e, t, n, o) {
  ...
  return ee({ width: u, height: d, x: a, y: c });
}
function Ce(e, t) {
...
function Pe(e, t, n) {
  ...
  if ("viewport" === t)
    ...
    o = (function (e) {
      ...
      const s = -n.scrollTop;
      return (
        "rtl" === ye(o).direction && (l += F(t.clientWidth, o.clientWidth) - r),
...
function ke(e, t) {
  const n = we(e);
  return (
    !(n === t || !ae(n) || ge(n)) && ("fixed" === ye(n).position || ke(n, t))
  );
}
function Ae(e, t, n) {
  const o = ce(t),
  ...
  getClippingRect: function (e) {
    ...
    const i = [
      ...
      s = i.reduce((e, n) => {
        ...
        return (
          (e.top = F(o.top, e.top)),
          (e.right = I(o.right, e.right)),
          (e.bottom = I(o.bottom, e.bottom)),
...
const Ne = function (e) {
    return (
      void 0 === e && (e = 0),
      {
        ...
        async fn(t) {
          var n, o;
          const { x: r, y: i, placement: l, middlewareData: s } = t,
            a = await (async function (e, t) {
              ...
              return (
                s && "number" == typeof p && (m = "end" === s ? -1 * p : p),
      ...
      void 0 === e && (e = {}),
      {
        ...
        async fn(t) {
          ...
          if (
            ...
            let n =
              null ==
              (M = O.filter((e) => e.overflows[0] <= 0).sort(
  ...
  Be = (e) => ({
    ...
    async fn(t) {
      ...
      let E = T ? T[w] : 0;
      (E && (await (null == l.isElement ? void 0 : l.isElement(T)))) ||
        (E = s.floating[w] || i.floating[p]);
      const R = x / 2 - b / 2,
        L = E / 2 - h[p] / 2 - 1,
        O = I(d[y], L),
        _ = I(d[v], L),
        ...
        k =
          ...
          null != U(r) &&
          D !== P &&
          i.reference[p] / 2 - (D < M ? O : _) - h[p] / 2 < 0,
        A = k ? (D < M ? D - M : D - C) : 0;
      return {
        [m]: f[m] + A,
        data: {
  ...
  qe = (e, t, n) => {
    ...
    return (async (e, t, n) => {
      ...
      return { x: u, y: d, placement: f, strategy: r, middlewareData: m };
    })(e, t, { ...r, platform: i });
  };
function $e(t) {
...
const Ye = ["right", "left", "bottom", "top"],
  Ze = ({
    ...
    var k, A, S;
    const { dispatch: z, modalDismissible: I } = s(),
      F = t(null),
      [H, j] = o(null),
      N = t(null),
      V = t(null),
      ...
      U = t(null),
      {
        ...
        const [x, b] = o(null),
          ...
          S = i(() => {
            ...
            const e = { placement: s, strategy: a, middleware: v };
            A.current && (e.platform = A.current),
              qe(M.current, C.current, e)
                .then((e) => {
        ...
        n(() => {
          !1 === h &&
            ...
            y((e) =>
              Object.assign(Object.assign({}, e), { isPositioned: !1 })
            ));
        }, [h]);
        const z = t(!1);
        n(
        ...
        const I = l(
          ...
          F = l(() => ({ reference: O, floating: _ }), [O, _]),
          H = l(() => {
            const e = { position: a, left: 0, top: 0 };
            ...
            return m
              ? Object.assign(
                  ...
                  $e(F.floating) >= 1.5 && { willChange: "transform" }
                )
        ...
        middleware: [
          We({ crossAxis: !1, fallbackPlacements: Ye.slice(1) }),
          Ve({ padding: 30 }),
          Ne(30),
          ((J = { element: N, padding: 28 }),
          {
            name: "arrow",
            options: J,
            fn(e) {
              const { element: t, padding: n } = J;
              return t && ((o = t), {}.hasOwnProperty.call(o, "current"))
                ? null != t.current
                  ? Be({ element: t.current, padding: n }).fn(e)
                  : {}
                : t
                ? Be({ element: t, padding: n }).fn(e)
                : {};
              var o;
            },
          }),
    ...
    n(() => {
      if (v) {
        let e;
        (e = "string" == typeof v ? c.querySelector(v) : v.current),
          j(e),
          Z.setReference(e),
          G();
      }
    }, [v, Z, G]),
      null === U.current && (U.current = c.documentElement.style.overflow),
      !V.current &&
        u() &&
        (V.current = new IntersectionObserver((t) => {
          for (const n of t) {
            n.boundingClientRect.top < 0 && e.scrollTo({ top: 0, left: 0 }),
      ...
      !F.current &&
        ...
        (F.current = new IntersectionObserver((t) => {
          ...
          for (const o of t) {
            if (
              (o.boundingClientRect.top < 0 && e.scrollTo({ top: 0, left: 0 }),
              !o.isIntersecting && o.target.offsetTop)
            ) {
              const t =
                ((null == H ? void 0 : H.offsetHeight) || 0) +
                ((null === (n = W.current) || void 0 === n
                  ? void 0
                  : n.offsetHeight) || 0) /
                  2 +
                30;
              e.scrollTo({ top: o.target.offsetTop - t });
            }
          }
        })),
      n(
    ...
    const { isDesktop: K } = d(),
      Q = l(() => (H && !M && K ? "dynamic" : "center"), [H, K, M]);
    n(() => {
    ...
    n(() => {
      ...
      n(() => {
        P
          ? ((c.documentElement.style.overflow = "hidden"),
            V.current && W.current && V.current.observe(W.current),
            F.current && H && F.current.observe(H))
          : (V.current && W.current && V.current.unobserve(W.current),
            F.current && H && F.current.unobserve(H),
            (c.documentElement.style.overflow = U.current || ""));
      }, [H, ee, P]),
      n(() => {
        var e;
    ...
    const te = f(
      ...
      ne = f(
        ...
        "center" === Q && "flex items-center justify-center",
        P ? "visible" : "pointer-events-none invisible"
      );
    let oe = "";
    "checkoutModal" === D &&
      (oe =
        "wide" === C ? "max-w-100 sm_max-w-none" : "max-w-85 sm_max-w-none");
    const re = f(
        ...
        P ? "opacity-100 sm_translate-y-0" : "opacity-0 sm_translate-y-full",
        "dynamic" === Q && P ? "scale-100" : "",
        "dynamic" !== Q || P ? "" : "scale-0 sm_scale-100",
        !E && ("wide" === C ? "min-w-100" : "min-w-85"),
        oe,
        !T && "rounded-xxl",
        !K && "max-h-full"
      ),
      ie = l(() => {
        ...
        return (
          "webkitTouchCallout" in c.documentElement.style &&
            (e = "-webkit-fill-available"),
          { maxHeight: e }
        );
      }, [K]),
      ...
      ae = l(() => {
        ...
        const a = {
            right: {
              ...
              left:
                (null === (t = Y.arrow) || void 0 === t ? void 0 : t.x) ||
                "-10px",
            },
            left: {
              top: null === (n = Y.arrow) || void 0 === n ? void 0 : n.y,
              right:
                (null === (o = Y.arrow) || void 0 === o ? void 0 : o.x) ||
                "-10px",
            },
            bottom: {
              top: "-10px",
              left:
                (null === (r = Y.arrow) || void 0 === r ? void 0 : r.x) ||
                "-10px",
            },
            top: {
              bottom: "-10px",
              left:
                (null === (i = Y.arrow) || void 0 === i ? void 0 : i.x) ||
                "-10px",
            },
          },
          c =
            Ye[
              (null ===
                (s =
                  null === (l = Y.flip) || void 0 === l
                    ? void 0
                    : l.overflows) || void 0 === s
                ? void 0
                : s.length) || 0
            ],
          u = a[c],
          d = f(
            ...
            "top" === c ? "bg-grayscale-l4" : "bg-white"
          );
        return m("div", {
          className: d,
        ...
        null === (k = Y.arrow) || void 0 === k ? void 0 : k.x,
        null === (A = Y.arrow) || void 0 === A ? void 0 : A.y,
        null === (S = Y.flip) || void 0 === S ? void 0 : S.overflows,
        Q,
      ]),
          ...
          children: m("div", {
            ...
            children: [
              ...
              m(
                h,
                Object.assign(
                  { as: "section", disabled: !B, "aria-modal": "true" },
                  ue,
                  {
                    "aria-label": L,
                    className: re,
        ...
        m("div", {
          ...
          children: [
            m("div", {
              ...
              children: [
                m("div", { class: "mr-3 size-6 rounded-max bg-grayscale-l2" }),
                m("div", {
                  class: "mr-20 h-3 flex-1 rounded-md bg-grayscale-l2",
                }),
              ],
            }),
            m("div", { class: "h-10 rounded-md bg-grayscale-l2" }),
          ],
        }),
        m("div", { class: "h-10 animate-pulse bg-grayscale-l3" }),
      ],
    }),
  Je = ({ children: e }) => {
    const { uiRendered: t } = s();
    return m(v, { children: [!t && m(Ge, {}), m("div", { children: e })] });
  },
...
const tt = w(
  (
    ...
    const { dispatch: Y, loaded: Z, modalVisible: G } = s(),
      { leaveBreadcrumb: J, notify: K } = x(),
      Q = b(),
      { clearLoadTimeout: ee, initLoadTimeout: te } = T(),
      { trackPageImpression: ne, trackPostMessageTransmission: oe } = E(),
      { recordCounter: re } = R(),
      ie = t(null),
      le = L(G),
      se = i(
        (e) => {
          Y({ type: "showModal", reason: e });
        },
        [Y]
      ),
      ae = i(
        ({ dismissMethod: t, reason: n }) => {
          G &&
            (Y({ type: "hideModal", reason: n, dismissMethod: t }),
    ...
    n(() => {
      const t = z(
        ...
        n = e;
      if ((null == n ? void 0 : n.current) && nt(n))
        return (
          n.current.addEventListener("click", t),
          () => {
            var e;
            null === (e = n.current) ||
              void 0 === e ||
    ...
    const ce = i(() => {
        P({ iframe: ie.current, src: B });
      }, [B]),
      { destroy: ue, waitForMessage: de } = O({
        includeCore: j,
        onClose: () =>
          ae({ dismissMethod: "auto", reason: "event_close_requested" }),
        onComplete: (e) =>
          k(void 0, void 0, void 0, function* () {
            !d && u && ae({ dismissMethod: "auto", reason: "event_completed" }),
        ...
        onError: (e) => {
          ...
          et(n, t)
            ? (J("authorize error", { code: n, message: t }, "state"),
              K(new A(t, "AuthorizeError")))
            : (re("shop_js_handle_silent_error", {
                attributes: { errorCode: n },
              }),
              J("silent error", { code: n }, "state")),
            ee(),
            null == y || y(e);
        },
        onLoaded: (e) => {
          Y({
            type: "loaded",
            payload: { autoOpen: Boolean(l), sessionDetected: e.userFound },
          }),
            null == v || v(e),
            ee();
        },
        ...
        onResizeIframe: (e) => {
          a || (ie.current && (ie.current.style.height = `${e.height}px`)),
            e.height > 0 && Y({ type: "uiRendered" }),
            null == I || I(e);
        },
        onShopUserMatched: () => {
          Q("shopusermatched"), J("shop user matched", {}, "state");
        },
        onShopUserNotMatched: ({ apiError: e }) => {
          Q("shopusernotmatched", e && { apiError: e }),
              ...
              S({
                contentWindow:
                  null === (n = ie.current) || void 0 === n
                    ...
                    : n.contentWindow,
                event: e,
                onMessageSent: (e) => oe({ direction: "outgoing", event: e }),
              });
          }
        ),
      [Z, oe, de]
    ...
    n(() => {
      ...
      if (G !== le)
        if (G) {
          try {
            fe({ type: "sheetmodalopened" }, { afterLoaded: !0 }),
              Q("modalopened");
          } catch (e) {
            K(
              new Error(`Error before calling onModalVisibleChange(true): ${e}`)
            );
          }
          null == w || w(!0);
        } else
          fe({ type: "sheetmodalclosed" }, { afterLoaded: !0 }),
            Q("modalclosed"),
            null == w || w(!1),
            null === (e = c.querySelector("com-1password-notification")) ||
              void 0 === e ||
              e.remove();
    }, [Q, G, K, w, fe, le]),
      _(
      ...
      n(() => {
        te(), J("Iframe url updated", { src: B }, "state");
      }, [te, J, B]),
      n(() => {
        G && ne({ page: "AUTHORIZE_MODAL" });
      }, [G, ne]),
      n(() => {
        P({ iframe: ie.current, src: B });
      }, [B]);
    const me = () => {
        ne({ page: "AUTHORIZE_MODAL_IN_VIEWPORT", allowDuplicates: !0 }),
      ...
      pe = m("iframe", {
        ...
        ref: (e) => {
          e &&
            ((ie.current = e),
            e.getAttribute("src") || e.setAttribute("src", B));
        },
        tabIndex: 0,
        scrolling: W,
      ...
      he = f
        ? m(M, { className: "size-8 text-purple-primary" })
        : m(C, { className: "h-4-5 text-purple-primary" });
    return N
      ? m(D, {
          anchorTo: r,
          headerLogo: he,
          headerTitle: f,
          hideHeader: !p,
          onDismiss: (e) => ae({ dismissMethod: e, reason: "user_dismissed" }),
          visible: G,
          children: m(Je, { children: pe }),
        })
      : u
      ? m(Ze, {
          anchorTo: r,
...
export { tt as A, Ze as M, et as i };
//# sourceMappingURL=chunk.modal_Coo4kjcu.esm.js.map
